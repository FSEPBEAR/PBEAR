...
void check_property() {
	...
	if (!(((direction_adjustment < 20) && (direction_adjustment > -20)))) __CPROVER_printf("violated property: Node_21_481");
...
signed int __iv__getbiggestrect_stub(U8 pcolorid, signed int pminarea){
	...
	if(nxtcamdata[39]==nxtcamdata[14]) if(nxtcamdata[36]>=nxtcamdata[19]) __iv__return_expr_getbiggestrect = (-1); else if(nxtcamdata[19]==nxtcamdata[13]) __iv__return_expr_getbiggestrect = (nxtcamdata[17]*nxtcamdata[17]); else __iv__return_expr_getbiggestrect = nxtcamdata[27]; else if(pcolorid<nxtcamdata[0]) if(nxtcamdata[18]>=nxtcamdata[21]) if(5==nxtcamdata[15]) __iv__return_expr_getbiggestrect = 6; else if(nxtcamdata[3]<nxtcamdata[11]) __iv__return_expr_getbiggestrect = pcolorid; else if(3<nxtcamdata[0]) if(nxtcamdata[22]==nxtcamdata[0]) __iv__return_expr_getbiggestrect = nxtcamdata[6]; else if(nxtcamdata[27]==nxtcamdata[0]) __iv__return_expr_getbiggestrect = 1; else if(nxtcamdata[6]==nxtcamdata[31]) if(nxtcamdata[36]==nxtcamdata[16]) __iv__return_expr_getbiggestrect = 7; else __iv__return_expr_getbiggestrect = 1; else if(nxtcamdata[6]<nxtcamdata[8]) __iv__return_expr_getbiggestrect = 2; else if(2>=nxtcamdata[39]) __iv__return_expr_getbiggestrect = 7; else __iv__return_expr_getbiggestrect = 5; else __iv__return_expr_getbiggestrect = 0; else __iv__return_expr_getbiggestrect = nxtcamdata[38]; else if(3==nxtcamdata[11]) if(nxtcamdata[29]==nxtcamdata[23]) __iv__return_expr_getbiggestrect = (-1); else __iv__return_expr_getbiggestrect = nxtcamdata[8]; else __iv__return_expr_getbiggestrect = (-1); 
