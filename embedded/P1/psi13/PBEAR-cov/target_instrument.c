...
__iv__current_func_call = 14;	getbiggestrect__1__1__1__1__area = getArea((U8)(i));
...
__iv__current_func_call = 15;	return_value_getWidth = getWidth(getArea__rectindex);
	signed int return_value_getHeight;
__iv__current_func_call = 16;	return_value_getHeight = getHeight(getArea__rectindex);
...
signed int ReleaseResource_Common(unsigned char resid) {
	...
	goto Node_8_181;
	Node_8_148:;
__iv__current_func_call = 17;	return_value_is_alloc_0 = is_alloc(resid);
...
__iv__current_func_call = 18;	return_value_is_alloc = is_alloc(i);
...
__iv__current_func_call = 19;	reschedule((API)(5), current_tid);
	goto Node_8_181;
	Node_8_181:;
	// End of Function
}
...
__iv__current_func_call = 21;	return_value_send_nxtcam_command = send_nxtcam_command((U8)(2), (U8)(69));
	tracking_enabled = (S8)(return_value_send_nxtcam_command);
	goto Node_9_228;
	Node_9_208:;
__iv__current_func_call = 22;	request((U8)(2));
__iv__current_func_call = 23;	rectindex = getbiggestrect((U8)(0), -1);
	if (!((rectindex >= 0))) goto Node_9_228;
__iv__current_func_call = 24;	area = getArea((U8)(rectindex));
__iv__current_func_call = 25;	area = median_filter(area);
__iv__current_func_call = 26;	acq_size = fisqrt(area);
__iv__current_func_call = 27;	x = getX((U8)(rectindex));
__iv__current_func_call = 28;	GetResource((unsigned char)(1));
	current_pc[1] = 2;
	goto Node_9_234;
	Node_9_221:;
	objData.position = x;
	objData.size = acq_size;
__iv__current_func_call = 29;	ReleaseResource((unsigned char)(1));
	current_pc[1] = 3;
	goto Node_9_234;
	Node_9_228:;
__iv__current_func_call = 30;	TerminateTask();
	current_pc[1] = 4;
	goto Node_9_234;
	Node_9_232:;
	current_pc[1] = 1;
...
signed int GetResource_Common(unsigned char resid) {
	...
	goto Node_19_452;
	Node_19_437:;
__iv__current_func_call = 37;	return_value_is_alloc = is_alloc(resid);
...
__iv__current_func_call = 64;	speedPIDController(ctl_size);
__iv__current_func_call = 65;	direction_adjustment = directionPIDController(position);
	Node_34_569:;
