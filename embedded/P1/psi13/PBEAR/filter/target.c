...
void is_alloc_37_1(unsigned char res);
void postjob_35_1();
...
void fisqrt_26_1(signed int val);
...
void is_alloc_37_2(unsigned char res);
void postjob_35_33();
...
void is_alloc_37_3(unsigned char res);
void postjob_35_53();
...
void check_property_36_55(){
	if (!(((direction_adjustment < 20) && (direction_adjustment > -20)))) __CPROVER_printf("violated property: Node_21_481");assert(((direction_adjustment < 20) && (direction_adjustment > -20)));
}
