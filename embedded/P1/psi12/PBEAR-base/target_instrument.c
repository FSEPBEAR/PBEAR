...
__iv__current_func_call = 36;	update_prop_automata();
__iv__current_func_call = 37;	check_property();
	count = (count + 1);
...
__iv__current_func_call = 38;	push_task_into_readyQ(reftask, task_static_info[(signed long int)(reftask)].prio, 0, (push_type)(0));
__iv__current_func_call = 39;	reschedule((API)(0), current_tid);
	Node_19_444:;
	Node_19_446:;
	// End of Function
}
...
signed int WaitEvent(unsigned char eventid) {
__iv__current_func_call = 43;	WaitEvent_Common(eventid);
	// End of Function
}
signed int TerminateTask() {
__iv__current_func_call = 45;	TerminateTask_Common();
	// End of Function
}
void StartOS(unsigned char app_mode) {
	if (!((os_on == OFF))) goto Node_25_471;
	os_on = ON;
__iv__current_func_call = 47;	initialize();
__iv__current_func_call = 48;	startup_process();
__iv__current_func_call = 49;	app();
	Node_25_471:;
	// End of Function
}
void ShutDownOS() {
...
signed int SetEvent(unsigned char reftask, unsigned char eventid) {
__iv__current_func_call = 52;	SetEvent_Common(reftask, eventid);
	// End of Function
}
signed int GetResource_Common(unsigned char resid) {
	signed int return_value_is_alloc;
	...
	goto Node_30_504;
	Node_30_489:;
__iv__current_func_call = 54;	return_value_is_alloc = is_alloc(resid);
...
signed int ReleaseResource(unsigned char resid) {
__iv__current_func_call = 56;	ReleaseResource_Common(resid);
	// End of Function
}
signed int GetResource(unsigned char resid) {
__iv__current_func_call = 58;	GetResource_Common(resid);
	// End of Function
}
signed int ClearEvent_Common(unsigned char eventid) {
	// End of Function
...
__iv__current_func_call = 61;	ActivateTask_Common(alarm_info[(signed long int)(aid)].param1);
	goto Node_34_532;
	Node_34_529:;
	if (!(((signed int)(alarm_info[(signed long int)(aid)].api) == 6))) goto Node_34_531;
__iv__current_func_call = 62;	SetEvent_Common(alarm_info[(signed long int)(aid)].param1, alarm_info[(signed long int)(aid)].param2);
	Node_34_531:;
	Node_34_532:;
...
void Func_ControlTask() {
	...
	goto Node_35_572;
	Node_35_550:;
__iv__current_func_call = 63;	GetResource((unsigned char)(1));
	current_pc[2] = 2;
	goto Node_35_574;
	Node_35_554:;
	data = objData;
__iv__current_func_call = 64;	ReleaseResource((unsigned char)(1));
	current_pc[2] = 3;
	goto Node_35_574;
	Node_35_560:;
	ctl_size = data.size;
...
__iv__current_func_call = 65;	speed_deviation = speedPIDController(ctl_size);
	new_speed = (50 + speed_deviation);
	new_speed = (new_speed > 100) ? 100 : new_speed;
__iv__current_func_call = 66;	directionPIDController(position);
	Node_35_568:;
__iv__current_func_call = 67;	TerminateTask();
	current_pc[2] = 4;
	goto Node_35_574;
	Node_35_572:;
	current_pc[2] = 1;
...
__iv__current_func_call = 68;	push_task_into_readyQ(reftask, task_static_info[(signed long int)(reftask)].prio, current_pc[(signed long int)(reftask)], (push_type)(2));
	Node_36_591:;
__iv__current_func_call = 69;	reschedule((API)(6), current_tid);
	Node_36_593:;
	Node_36_594:;
	// End of Function
}
signed int Schedule_Common() {
__iv__current_func_call = 71;	reschedule((API)(3), current_tid);
	// End of Function
}
signed int ChainTask_Common(unsigned char reftask) {
	goto Node_38_604;
...
signed int ActivateTask(unsigned char reftask) {
__iv__current_func_call = 74;	ActivateTask_Common(reftask);
	// End of Function
}
signed int ClearEvent(unsigned char eventid) {
	// End of Function
...
signed int Schedule() {
__iv__current_func_call = 77;	Schedule_Common();
	// End of Function
}
signed int TerminateTask_Common() {
	...
	Node_43_693:;
__iv__current_func_call = 79;	reschedule((API)(1), current_tid);
	// End of Function
}
signed int ChainTask(unsigned char reftask) {
__iv__current_func_call = 81;	ChainTask_Common(reftask);
	// End of Function
}
void term_nxtcam(U8 port_id) {
	// End of Function
...
__iv__current_func_call = 87;	push_task_into_readyQ((unsigned char)(i), current_prio, 0, (push_type)(0));
...
__iv__current_func_call = 88;	get_task_from_readyQ();
