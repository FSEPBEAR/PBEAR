...
void app() {
	...
	postjob();
	printf("_tr_call:update_prop_automata;_tr_call_id:36;\n");fflush(stdout);
	update_prop_automata();
	printf("_tr_call:check_property;_tr_call_id:37;\n");fflush(stdout);
	check_property();
		count = (count + 1);
	printf("_tr_node_id:Node_18_420;_tr_assign:count=%d;\n", count);fflush(stdout);
	__iv__branch_expr = (1 != 0);
	printf("_tr_node_id:Node_18_421;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
...
signed int ActivateTask_Common(unsigned char reftask) {
	...
	printf("_tr_node_id:Node_19_426;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_19_430;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((signed int)(task_state[(signed long int)(reftask)]) == 0))) goto Node_19_440;
	printf("_tr_node_id:Node_19_431;_tr_decl:i;\n");fflush(stdout);
	signed int i;
		i = 0;
	printf("_tr_node_id:Node_19_432;_tr_assign:i=%d;\n", i);fflush(stdout);
	Node_19_434:;
	...
	printf("_tr_node_id:Node_19_441;_tr_assign:task_dyn_info[%u].act_cnt=%hhu;\n", __iv__index_expr_var11, task_dyn_info[__iv__index_expr_var11].act_cnt);fflush(stdout);
	printf("_tr_call:push_task_into_readyQ;_tr_call_id:38;\n");fflush(stdout);
	...
	printf("_tr_call:reschedule;_tr_call_id:39;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:reschedule__api=%d;\n", (API)(0));fflush(stdout);
	printf("_tr_param;_tr_assign:tid=%hhu;\n", current_tid);fflush(stdout);
...
signed int WaitEvent(unsigned char eventid) {
	printf("_tr_call:WaitEvent_Common;_tr_call_id:43;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:eventid=%hhu;\n", eventid);fflush(stdout);
	WaitEvent_Common(eventid);
	printf("_tr_return;\n");fflush(stdout);
}
signed int TerminateTask() {
	printf("_tr_call:TerminateTask_Common;_tr_call_id:45;\n");fflush(stdout);
	TerminateTask_Common();
	printf("_tr_return;\n");fflush(stdout);
}
void StartOS(unsigned char app_mode) {
	__iv__branch_expr = !((os_on == OFF));
	printf("_tr_node_id:Node_25_466;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((os_on == OFF))) goto Node_25_471;
		os_on = ON;
	printf("_tr_node_id:Node_25_467;_tr_assign:os_on=%d;\n", os_on);fflush(stdout);
	printf("_tr_call:initialize;_tr_call_id:47;\n");fflush(stdout);
	initialize();
	printf("_tr_call:startup_process;_tr_call_id:48;\n");fflush(stdout);
	startup_process();
	printf("_tr_call:app;_tr_call_id:49;\n");fflush(stdout);
	app();
	Node_25_471:;
	printf("_tr_return;\n");fflush(stdout);
}
...
signed int SetEvent(unsigned char reftask, unsigned char eventid) {
	printf("_tr_call:SetEvent_Common;_tr_call_id:52;\n");fflush(stdout);
...
signed int GetResource_Common(unsigned char resid) {
	printf("_tr_node_id:Node_30_484;_tr_decl:return_value_is_alloc;\n");fflush(stdout);
	signed int return_value_is_alloc;
	printf("_tr_node_id:Node_30_485;_tr_decl:tmp_if_expr;\n");fflush(stdout);
	__CPROVER_bool tmp_if_expr;
	__iv__branch_expr = !((!(((signed int)(resid) >= 0)) || ((signed int)(resid) >= 3)));
	printf("_tr_node_id:Node_30_486;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((!(((signed int)(resid) >= 0)) || ((signed int)(resid) >= 3)))) goto Node_30_489;
	goto Node_30_504;
	Node_30_489:;
	printf("_tr_call:is_alloc;_tr_call_id:54;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:res=%hhu;\n", resid);fflush(stdout);
		return_value_is_alloc = is_alloc(resid);
	printf("_tr_node_id:Node_30_489;_tr_assign:return_value_is_alloc=%d;\n", return_value_is_alloc);fflush(stdout);
	__iv__branch_expr = !((return_value_is_alloc >= 1));
	printf("_tr_node_id:Node_30_490;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((return_value_is_alloc >= 1))) goto Node_30_493;
		tmp_if_expr = (1 != 0);
	printf("_tr_node_id:Node_30_491;_tr_assign:tmp_if_expr=%hhu;\n", tmp_if_expr);fflush(stdout);
	goto Node_30_494;
	Node_30_493:;
	...
	printf("_tr_node_id:Node_30_493;_tr_assign:tmp_if_expr=%hhu;\n", tmp_if_expr);fflush(stdout);
	Node_30_494:;
	__iv__branch_expr = !tmp_if_expr;
	printf("_tr_node_id:Node_30_495;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_30_499;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_30_500;_tr_assign:task_dyn_info[%u].dyn_prio=%hhu;\n", __iv__index_expr_var13, task_dyn_info[__iv__index_expr_var13].dyn_prio);fflush(stdout);
	Node_30_501:;
	Node_30_504:;
	printf("_tr_return;\n");fflush(stdout);
}
signed int ReleaseResource(unsigned char resid) {
	printf("_tr_call:ReleaseResource_Common;_tr_call_id:56;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", resid);fflush(stdout);
	ReleaseResource_Common(resid);
	printf("_tr_return;\n");fflush(stdout);
}
signed int GetResource(unsigned char resid) {
	printf("_tr_call:GetResource_Common;_tr_call_id:58;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", resid);fflush(stdout);
...
void ALARM_handler(signed int aid) {
	...
	printf("_tr_node_id:Node_34_518;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_34_526;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((signed int)(alarm_info[(signed long int)(aid)].api) == 0))) goto Node_34_529;
	printf("_tr_call:ActivateTask_Common;_tr_call_id:61;\n");fflush(stdout);
	...
	printf("_tr_node_id:Node_34_529;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((signed int)(alarm_info[(signed long int)(aid)].api) == 6))) goto Node_34_531;
	printf("_tr_call:SetEvent_Common;_tr_call_id:62;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:reftask=%hhu;\n", alarm_info[(signed long int)(aid)].param1);fflush(stdout);
...
void Func_ControlTask() {
	...
	printf("_tr_node_id:Node_35_544;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	goto Node_35_572;
	Node_35_550:;
	printf("_tr_call:GetResource;_tr_call_id:63;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", (unsigned char)(1));fflush(stdout);
	GetResource((unsigned char)(1));
	unsigned int __iv__index_expr_var19 = (unsigned) (2);
		current_pc[2] = 2;
	printf("_tr_node_id:Node_35_552;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var19, current_pc[__iv__index_expr_var19]);fflush(stdout);
	goto Node_35_574;
	Node_35_554:;
		data = objData;
	printf("_tr_node_id:Node_35_556;_tr_dynamic_assign:	data = objData;\n");fflush(stdout);
	printf("_tr_call:ReleaseResource;_tr_call_id:64;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", (unsigned char)(1));fflush(stdout);
	ReleaseResource((unsigned char)(1));
	unsigned int __iv__index_expr_var20 = (unsigned) (2);
		current_pc[2] = 3;
	printf("_tr_node_id:Node_35_558;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var20, current_pc[__iv__index_expr_var20]);fflush(stdout);
	goto Node_35_574;
	Node_35_560:;
		ctl_size = data.size;
	printf("_tr_node_id:Node_35_561;_tr_assign:ctl_size=%d;\n", ctl_size);fflush(stdout);
		position = data.position;
	printf("_tr_node_id:Node_35_562;_tr_assign:position=%d;\n", position);fflush(stdout);
	__iv__branch_expr = !(((ctl_size >= 1) && (position >= 1)));
	printf("_tr_node_id:Node_35_563;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((ctl_size >= 1) && (position >= 1)))) goto Node_35_568;
	printf("_tr_call:speedPIDController;_tr_call_id:65;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:d=%d;\n", ctl_size);fflush(stdout);
		speed_deviation = speedPIDController(ctl_size);
	printf("_tr_node_id:Node_35_564;_tr_assign:speed_deviation=%d;\n", speed_deviation);fflush(stdout);
	...
	printf("_tr_node_id:Node_35_566;_tr_assign:new_speed=%d;\n", new_speed);fflush(stdout);
	printf("_tr_call:directionPIDController;_tr_call_id:66;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:d=%d;\n", position);fflush(stdout);
	directionPIDController(position);
	Node_35_568:;
	printf("_tr_call:TerminateTask;_tr_call_id:67;\n");fflush(stdout);
	TerminateTask();
	unsigned int __iv__index_expr_var21 = (unsigned) (2);
		current_pc[2] = 4;
	printf("_tr_node_id:Node_35_570;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var21, current_pc[__iv__index_expr_var21]);fflush(stdout);
	goto Node_35_574;
	Node_35_572:;
	unsigned int __iv__index_expr_var22 = (unsigned) (2);
		current_pc[2] = 1;
	printf("_tr_node_id:Node_35_573;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var22, current_pc[__iv__index_expr_var22]);fflush(stdout);
	Node_35_574:;
	printf("_tr_return;\n");fflush(stdout);
}
signed int SetEvent_Common(unsigned char reftask, unsigned char eventid) {
	__iv__branch_expr = !((!(((signed int)(reftask) >= 1)) || ((signed int)(reftask) >= 5)));
	printf("_tr_node_id:Node_36_576;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_36_579;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((signed int)(task_static_info[(signed long int)(reftask)].extended) == 0))) goto Node_36_582;
	goto Node_36_594;
	Node_36_582:;
	__iv__branch_expr = ((signed int)(task_state[(signed long int)(reftask)]) == 0);
	printf("_tr_node_id:Node_36_582;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_36_587;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	Node_36_591:;
	printf("_tr_call:reschedule;_tr_call_id:69;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:reschedule__api=%d;\n", (API)(6));fflush(stdout);
	printf("_tr_param;_tr_assign:tid=%hhu;\n", current_tid);fflush(stdout);
...
signed int Schedule_Common() {
	printf("_tr_call:reschedule;_tr_call_id:71;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:reschedule__api=%d;\n", (API)(3));fflush(stdout);
	printf("_tr_param;_tr_assign:tid=%hhu;\n", current_tid);fflush(stdout);
...
signed int ActivateTask(unsigned char reftask) {
	printf("_tr_call:ActivateTask_Common;_tr_call_id:74;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:reftask=%hhu;\n", reftask);fflush(stdout);
...
signed int Schedule() {
	printf("_tr_call:Schedule_Common;_tr_call_id:77;\n");fflush(stdout);
	Schedule_Common();
	printf("_tr_return;\n");fflush(stdout);
}
signed int TerminateTask_Common() {
	__iv__branch_expr = !(((signed int)(task_dyn_info[(signed long int)(current_tid)].act_cnt) >= 1));
	printf("_tr_node_id:Node_43_686;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_43_687;_tr_assign:task_dyn_info[%u].act_cnt=%hhu;\n", __iv__index_expr_var25, task_dyn_info[__iv__index_expr_var25].act_cnt);fflush(stdout);
	Node_43_688:;
	__iv__branch_expr = !(((signed int)(task_dyn_info[(signed long int)(current_tid)].act_cnt) >= 1));
	printf("_tr_node_id:Node_43_689;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
...
signed int ChainTask(unsigned char reftask) {
	printf("_tr_call:ChainTask_Common;_tr_call_id:81;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:reftask=%hhu;\n", reftask);fflush(stdout);
...
signed int fisqrt(signed int val) {
	printf("_tr_node_id:Node_48_708;_tr_decl:cnt;\n");fflush(stdout);
	signed int cnt;
		cnt = 0;
	printf("_tr_node_id:Node_48_709;_tr_assign:cnt=%d;\n", cnt);fflush(stdout);
	printf("_tr_node_id:Node_48_710;_tr_decl:t;\n");fflush(stdout);
	signed int t;
		t = val;
	printf("_tr_node_id:Node_48_711;_tr_assign:t=%d;\n", t);fflush(stdout);
	Node_48_713:;
	__iv__branch_expr = (t == 0);
	printf("_tr_node_id:Node_48_713;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((t == 0)) goto Node_48_717;
		cnt = (cnt + 1);
	printf("_tr_node_id:Node_48_714;_tr_assign:cnt=%d;\n", cnt);fflush(stdout);
		t = (t >> 1);
	printf("_tr_node_id:Node_48_715;_tr_assign:t=%d;\n", t);fflush(stdout);
	goto Node_48_713;
	Node_48_717:;
	__iv__branch_expr = (cnt >= 7);
	printf("_tr_node_id:Node_48_718;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((cnt >= 7)) goto Node_48_721;
		t = (val << (6 - cnt));
	printf("_tr_node_id:Node_48_719;_tr_assign:t=%d;\n", t);fflush(stdout);
	goto Node_48_722;
	Node_48_721:;
		t = (val >> (cnt - 6));
	printf("_tr_node_id:Node_48_721;_tr_assign:t=%d;\n", t);fflush(stdout);
	Node_48_722:;
	__iv__return_expr_fisqrt = 	((ftbl[(signed long int)(cnt)] * ftbl2[(signed long int)((t & 31))]) >> 15);
	printf("_tr_node_id:Node_48_723;_tr_assign:__iv__return_expr_fisqrt=%d;\n", __iv__return_expr_fisqrt);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_fisqrt;
}
void update_prop_automata() {
	__iv__branch_expr = !((state == 0));
	printf("_tr_node_id:Node_49_728;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((state == 0))) goto Node_49_733;
	__iv__branch_expr = !((new_speed >= 71));
	printf("_tr_node_id:Node_49_729;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((new_speed >= 71))) goto Node_49_731;
		state = 1;
	printf("_tr_node_id:Node_49_730;_tr_assign:state=%d;\n", state);fflush(stdout);
	Node_49_731:;
	goto Node_49_744;
	Node_49_733:;
	__iv__branch_expr = !((state == 1));
	printf("_tr_node_id:Node_49_733;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((state == 1))) goto Node_49_743;
	__iv__branch_expr = (new_speed >= 10);
	printf("_tr_node_id:Node_49_734;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((new_speed >= 10)) goto Node_49_737;
		state = 2;
	printf("_tr_node_id:Node_49_735;_tr_assign:state=%d;\n", state);fflush(stdout);
	goto Node_49_742;
	Node_49_737:;
	__iv__branch_expr = !((new_speed >= 71));
	printf("_tr_node_id:Node_49_737;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((new_speed >= 71))) goto Node_49_740;
		state = 1;
	printf("_tr_node_id:Node_49_738;_tr_assign:state=%d;\n", state);fflush(stdout);
	goto Node_49_741;
	Node_49_740:;
		state = 0;
	printf("_tr_node_id:Node_49_740;_tr_assign:state=%d;\n", state);fflush(stdout);
	Node_49_741:;
	Node_49_742:;
	Node_49_743:;
	Node_49_744:;
...
void startup_process() {
	printf("_tr_node_id:Node_53_754;_tr_decl:i;\n");fflush(stdout);
	unsigned int i;
		i = 0u;
	printf("_tr_node_id:Node_53_755;_tr_assign:i=%u;\n", i);fflush(stdout);
	Node_53_757:;
	__iv__branch_expr = (i >= 4u);
	printf("_tr_node_id:Node_53_757;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((i >= 4u)) goto Node_53_766;
	__iv__branch_expr = ((signed int)(task_static_info[(signed long int)(i)].autostart) == 0);
	printf("_tr_node_id:Node_53_758;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_53_759;_tr_assign:task_dyn_info[%u].act_cnt=%hhu;\n", __iv__index_expr_var28, task_dyn_info[__iv__index_expr_var28].act_cnt);fflush(stdout);
		current_prio = task_static_info[(signed long int)(i)].prio;
	printf("_tr_node_id:Node_53_760;_tr_assign:current_prio=%hhu;\n", current_prio);fflush(stdout);
	printf("_tr_call:push_task_into_readyQ;_tr_call_id:87;\n");fflush(stdout);
	...
	printf("_tr_node_id:Node_53_762;_tr_assign:task_state[%u]=%hhu;\n", __iv__index_expr_var29, task_state[__iv__index_expr_var29]);fflush(stdout);
	Node_53_763:;
		i = (i + 1u);
	printf("_tr_node_id:Node_53_764;_tr_assign:i=%u;\n", i);fflush(stdout);
	goto Node_53_757;
	Node_53_766:;
	__iv__branch_expr = (wholesize == 0);
	printf("_tr_node_id:Node_53_767;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((wholesize == 0)) goto Node_53_770;
	printf("_tr_call:get_task_from_readyQ;_tr_call_id:88;\n");fflush(stdout);
	...
	printf("_tr_node_id:Node_53_769;_tr_assign:task_state[%u]=%hhu;\n", __iv__index_expr_var30, task_state[__iv__index_expr_var30]);fflush(stdout);
	Node_53_770:;
	printf("_tr_return;\n");fflush(stdout);
}
signed int directionPIDController(signed int d) {
	printf("_tr_node_id:Node_54_773;_tr_decl:error;\n");fflush(stdout);
	signed int error;
		error = (83 - d);
	printf("_tr_node_id:Node_54_774;_tr_assign:error=%d;\n", error);fflush(stdout);
		integral = (integral + error);
	printf("_tr_node_id:Node_54_775;_tr_assign:integral=%d;\n", integral);fflush(stdout);
		prevError = error;
	printf("_tr_node_id:Node_54_776;_tr_assign:prevError=%d;\n", prevError);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
}
void display_goto_xy(signed int display_goto_xy__x, signed int y) {
	printf("_tr_return;\n");fflush(stdout);
...
void get_task_from_readyQ() {
	__iv__branch_expr = !((wholesize == 0));
	printf("_tr_node_id:Node_62_796;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((wholesize == 0))) goto Node_62_800;
		current_tid = (unsigned char)(0);
	printf("_tr_node_id:Node_62_797;_tr_assign:current_tid=%hhu;\n", current_tid);fflush(stdout);
		current_prio = (unsigned char)(0);
	printf("_tr_node_id:Node_62_798;_tr_assign:current_prio=%hhu;\n", current_prio);fflush(stdout);
	goto Node_62_816;
	Node_62_800:;
		current_tid = readyQ[(signed long int)(max_prio)][(signed long int)(front[(signed long int)(max_prio)])].tid;
	printf("_tr_node_id:Node_62_800;_tr_assign:current_tid=%hhu;\n", current_tid);fflush(stdout);
		current_prio = max_prio;
	printf("_tr_node_id:Node_62_801;_tr_assign:current_prio=%hhu;\n", current_prio);fflush(stdout);
	...
	printf("_tr_node_id:Node_62_804;_tr_assign:size[%u]=%d;\n", __iv__index_expr_var34, size[__iv__index_expr_var34]);fflush(stdout);
		wholesize = (wholesize - 1);
	printf("_tr_node_id:Node_62_805;_tr_assign:wholesize=%d;\n", wholesize);fflush(stdout);
		max_prio = current_prio;
	printf("_tr_node_id:Node_62_806;_tr_assign:max_prio=%hhu;\n", max_prio);fflush(stdout);
	Node_62_808:;
	__iv__branch_expr = !((size[(signed long int)(max_prio)] == 0));
	printf("_tr_node_id:Node_62_808;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
...
void push_task_into_readyQ(unsigned char t, unsigned char p, signed int pc, push_type pushkind) {
	...
	printf("_tr_node_id:Node_70_863;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
...
signed int reschedule(API reschedule__api, unsigned char tid) {
	...
	printf("_tr_node_id:Node_71_882;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_71_886;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_71_889;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
