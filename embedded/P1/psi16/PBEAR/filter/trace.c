...
signed int getbiggestrect(U8 pcolorid, signed int pminarea) {
	printf("_tr_node_id:Node_7_102;_tr_decl:getbiggestrect__1__rectindex;\n");fflush(stdout);
	signed int getbiggestrect__1__rectindex;
		getbiggestrect__1__rectindex = -1;
	printf("_tr_node_id:Node_7_103;_tr_assign:getbiggestrect__1__rectindex=%d;\n", getbiggestrect__1__rectindex);fflush(stdout);
	printf("_tr_node_id:Node_7_104;_tr_decl:i;\n");fflush(stdout);
	signed int i;
	printf("_tr_node_id:Node_7_105;_tr_decl:maxarea;\n");fflush(stdout);
	signed int maxarea;
		maxarea = pminarea;
	printf("_tr_node_id:Node_7_106;_tr_assign:maxarea=%d;\n", maxarea);fflush(stdout);
		i = 0;
	printf("_tr_node_id:Node_7_107;_tr_assign:i=%d;\n", i);fflush(stdout);
	Node_7_109:;
	__iv__branch_expr = (i >= (signed int)(nxtcamdata[0]));
	printf("_tr_node_id:Node_7_109;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((i >= (signed int)(nxtcamdata[0]))) goto Node_7_130;
	printf("_tr_node_id:Node_7_110;_tr_decl:colorid;\n");fflush(stdout);
	signed int colorid;
		colorid = (signed int)(nxtcamdata[(signed long int)(((1 + (5 * i)) + 0))]);
	printf("_tr_node_id:Node_7_111;_tr_assign:colorid=%d;\n", colorid);fflush(stdout);
	__iv__branch_expr = !((colorid == (signed int)(pcolorid)));
	printf("_tr_node_id:Node_7_112;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((colorid == (signed int)(pcolorid)))) goto Node_7_126;
	printf("_tr_node_id:Node_7_113;_tr_decl:getbiggestrect__1__1__1__1__area;\n");fflush(stdout);
	signed int getbiggestrect__1__1__1__1__area;
	printf("_tr_call:getArea;_tr_call_id:15;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:getArea__rectindex=%hhu;\n", (U8)(i));fflush(stdout);
		getbiggestrect__1__1__1__1__area = getArea((U8)(i));
	printf("_tr_node_id:Node_7_118;_tr_assign:getbiggestrect__1__1__1__1__area=%d;\n", getbiggestrect__1__1__1__1__area);fflush(stdout);
	...
	printf("_tr_node_id:Node_7_120;_tr_assign:maxarea=%d;\n", maxarea);fflush(stdout);
		getbiggestrect__1__rectindex = i;
	printf("_tr_node_id:Node_7_121;_tr_assign:getbiggestrect__1__rectindex=%d;\n", getbiggestrect__1__rectindex);fflush(stdout);
	Node_7_122:;
	Node_7_126:;
		i = (i + 1);
	printf("_tr_node_id:Node_7_128;_tr_assign:i=%d;\n", i);fflush(stdout);
	goto Node_7_109;
	Node_7_130:;
	__iv__return_expr_getbiggestrect = 	getbiggestrect__1__rectindex;
	printf("_tr_node_id:Node_7_131;_tr_assign:__iv__return_expr_getbiggestrect=%d;\n", __iv__return_expr_getbiggestrect);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_getbiggestrect;
}
signed int getArea(U8 getArea__rectindex) {
	printf("_tr_node_id:Node_8_137;_tr_decl:return_value_getWidth;\n");fflush(stdout);
	signed int return_value_getWidth;
	printf("_tr_call:getWidth;_tr_call_id:16;\n");fflush(stdout);
...
signed int ReleaseResource_Common(unsigned char resid) {
	...
	unsigned char i;
	printf("_tr_node_id:Node_9_153;_tr_decl:return_value_is_alloc_0;\n");fflush(stdout);
	signed int return_value_is_alloc_0;
	__iv__branch_expr = !((!(((signed int)(resid) >= 0)) || ((signed int)(resid) >= 3)));
	printf("_tr_node_id:Node_9_154;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_9_157;_tr_assign:return_value_is_alloc_0=%d;\n", return_value_is_alloc_0);fflush(stdout);
	__iv__branch_expr = (return_value_is_alloc_0 == (signed int)(current_tid));
	printf("_tr_node_id:Node_9_158;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_9_165;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_9_166;_tr_assign:current_prio=%hhu;\n", current_prio);fflush(stdout);
		i = (unsigned char)(0);
	printf("_tr_node_id:Node_9_167;_tr_assign:i=%hhu;\n", i);fflush(stdout);
	Node_9_168:;
	__iv__branch_expr = ((signed int)(i) >= 3);
	printf("_tr_node_id:Node_9_168;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (((signed int)(i) >= 3)) goto Node_9_182;
	printf("_tr_node_id:Node_9_169;_tr_decl:return_value_is_alloc;\n");fflush(stdout);
	signed int return_value_is_alloc;
	printf("_tr_call:is_alloc;_tr_call_id:19;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:res=%hhu;\n", i);fflush(stdout);
		return_value_is_alloc = is_alloc(i);
	printf("_tr_node_id:Node_9_171;_tr_assign:return_value_is_alloc=%d;\n", return_value_is_alloc);fflush(stdout);
	__iv__branch_expr = !((return_value_is_alloc == (signed int)(current_tid)));
	printf("_tr_node_id:Node_9_173;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_9_174;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_9_175;_tr_assign:current_prio=%hhu;\n", current_prio);fflush(stdout);
	Node_9_176:;
	Node_9_177:;
		i = (unsigned char)(((signed int)(i) + 1));
	printf("_tr_node_id:Node_9_178;_tr_assign:i=%hhu;\n", i);fflush(stdout);
	goto Node_9_168;
	Node_9_182:;
	Node_9_183:;
...
signed int speedPIDController(signed int d) {
	printf("_tr_node_id:Node_10_195;_tr_decl:error;\n");fflush(stdout);
	signed int error;
		error = (50 - d);
	printf("_tr_node_id:Node_10_196;_tr_assign:error=%d;\n", error);fflush(stdout);
		integral = (integral + error);
	printf("_tr_node_id:Node_10_197;_tr_assign:integral=%d;\n", integral);fflush(stdout);
	printf("_tr_node_id:Node_10_198;_tr_decl:derivative;\n");fflush(stdout);
	signed int derivative;
		derivative = (error - prevError);
	printf("_tr_node_id:Node_10_199;_tr_assign:derivative=%d;\n", derivative);fflush(stdout);
	printf("_tr_node_id:Node_10_200;_tr_decl:out;\n");fflush(stdout);
	signed int out;
		out = (signed int)((((1.5 * (double)(error)) + (double)((0 * integral))) + (double)((0 * derivative))));
	printf("_tr_node_id:Node_10_201;_tr_assign:out=%d;\n", out);fflush(stdout);
	__iv__return_expr_speedPIDController = 	out;
	printf("_tr_node_id:Node_10_202;_tr_assign:__iv__return_expr_speedPIDController=%d;\n", __iv__return_expr_speedPIDController);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_speedPIDController;
}
data_t median_filter(data_t datum) {
	printf("_tr_node_id:Node_11_208;_tr_decl:successor;\n");fflush(stdout);
	struct pair *successor;
	printf("_tr_node_id:Node_11_209;_tr_decl:scan;\n");fflush(stdout);
	struct pair *scan;
	printf("_tr_node_id:Node_11_210;_tr_decl:scanold;\n");fflush(stdout);
	struct pair *scanold;
	printf("_tr_node_id:Node_11_211;_tr_decl:median;\n");fflush(stdout);
	struct pair *median;
	printf("_tr_node_id:Node_11_212;_tr_decl:i;\n");fflush(stdout);
	unsigned int i;
		datpoint = (datpoint + 1l);
	printf("_tr_node_id:Node_11_213;_tr_dynamic_assign:	datpoint = (datpoint + 1l);\n");fflush(stdout);
	__iv__branch_expr = !(((datpoint - buffer) >= 15l));
	printf("_tr_node_id:Node_11_214;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((datpoint - buffer) >= 15l))) goto Node_11_216;
		datpoint = buffer;
	printf("_tr_node_id:Node_11_215;_tr_dynamic_assign:	datpoint = buffer;\n");fflush(stdout);
	Node_11_216:;
		datpoint->value = datum;
	printf("_tr_node_id:Node_11_217;_tr_assign:datpoint->value=%d;\n", datpoint->value);fflush(stdout);
		successor = datpoint->point;
	printf("_tr_node_id:Node_11_218;_tr_dynamic_assign:	successor = datpoint->point;\n");fflush(stdout);
		median = &big;
	printf("_tr_node_id:Node_11_219;_tr_dynamic_assign:	median = &big;\n");fflush(stdout);
		scan = &big;
	printf("_tr_node_id:Node_11_220;_tr_dynamic_assign:	scan = &big;\n");fflush(stdout);
	__iv__branch_expr = !((scan->point == datpoint));
	printf("_tr_node_id:Node_11_221;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((scan->point == datpoint))) goto Node_11_223;
		scan->point = successor;
	printf("_tr_node_id:Node_11_222;_tr_dynamic_assign:	scan->point = successor;\n");fflush(stdout);
	Node_11_223:;
		scanold = scan;
	printf("_tr_node_id:Node_11_224;_tr_dynamic_assign:	scanold = scan;\n");fflush(stdout);
		scan = scan->point;
	printf("_tr_node_id:Node_11_225;_tr_dynamic_assign:	scan = scan->point;\n");fflush(stdout);
		i = 0u;
	printf("_tr_node_id:Node_11_226;_tr_assign:i=%u;\n", i);fflush(stdout);
	Node_11_228:;
	__iv__branch_expr = (i >= 15u);
	printf("_tr_node_id:Node_11_228;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((i >= 15u)) goto Node_11_258;
	__iv__branch_expr = !((scan->point == datpoint));
	printf("_tr_node_id:Node_11_229;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((scan->point == datpoint))) goto Node_11_231;
		scan->point = successor;
	printf("_tr_node_id:Node_11_230;_tr_dynamic_assign:	scan->point = successor;\n");fflush(stdout);
	Node_11_231:;
	...
	printf("_tr_node_id:Node_11_233;_tr_dynamic_assign:	datpoint->point = scanold->point;\n");fflush(stdout);
		scanold->point = datpoint;
	printf("_tr_node_id:Node_11_234;_tr_dynamic_assign:	scanold->point = datpoint;\n");fflush(stdout);
		datum = 0;
	printf("_tr_node_id:Node_11_235;_tr_assign:datum=%d;\n", datum);fflush(stdout);
	Node_11_236:;
		median = median->point;
	printf("_tr_node_id:Node_11_237;_tr_dynamic_assign:	median = median->point;\n");fflush(stdout);
	__iv__branch_expr = (scan == &small);
	printf("_tr_node_id:Node_11_238;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((scan == &small)) goto Node_11_258;
		scanold = scan;
	printf("_tr_node_id:Node_11_241;_tr_dynamic_assign:	scanold = scan;\n");fflush(stdout);
		scan = scan->point;
	printf("_tr_node_id:Node_11_242;_tr_dynamic_assign:	scan = scan->point;\n");fflush(stdout);
	__iv__branch_expr = !((scan->point == datpoint));
	printf("_tr_node_id:Node_11_243;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((scan->point == datpoint))) goto Node_11_245;
		scan->point = successor;
	printf("_tr_node_id:Node_11_244;_tr_dynamic_assign:	scan->point = successor;\n");fflush(stdout);
	Node_11_245:;
	__iv__branch_expr = (scan->value >= datum);
	printf("_tr_node_id:Node_11_246;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((scan->value >= datum)) goto Node_11_250;
		datpoint->point = scanold->point;
	printf("_tr_node_id:Node_11_247;_tr_dynamic_assign:	datpoint->point = scanold->point;\n");fflush(stdout);
		scanold->point = datpoint;
	printf("_tr_node_id:Node_11_248;_tr_dynamic_assign:	scanold->point = datpoint;\n");fflush(stdout);
		datum = 0;
	printf("_tr_node_id:Node_11_249;_tr_assign:datum=%d;\n", datum);fflush(stdout);
	Node_11_250:;
	__iv__branch_expr = (scan == &small);
	printf("_tr_node_id:Node_11_251;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((scan == &small)) goto Node_11_258;
		scanold = scan;
	printf("_tr_node_id:Node_11_254;_tr_dynamic_assign:	scanold = scan;\n");fflush(stdout);
		scan = scan->point;
	printf("_tr_node_id:Node_11_255;_tr_dynamic_assign:	scan = scan->point;\n");fflush(stdout);
		i = (i + 1u);
	printf("_tr_node_id:Node_11_256;_tr_assign:i=%u;\n", i);fflush(stdout);
	goto Node_11_228;
	Node_11_258:;
	__iv__return_expr_median_filter = 	median->value;
	printf("_tr_node_id:Node_11_259;_tr_assign:__iv__return_expr_median_filter=%d;\n", __iv__return_expr_median_filter);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_median_filter;
}
signed int is_active_obj_exists() {
	printf("_tr_node_id:Node_12_267;_tr_decl:i;\n");fflush(stdout);
	signed int i;
		i = 1;
	printf("_tr_node_id:Node_12_268;_tr_assign:i=%d;\n", i);fflush(stdout);
	Node_12_270:;
	__iv__branch_expr = (i >= 4);
	printf("_tr_node_id:Node_12_270;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((i >= 4)) goto Node_12_286;
	printf("_tr_node_id:Node_12_271;_tr_decl:tmp_if_expr;\n");fflush(stdout);
	__CPROVER_bool tmp_if_expr;
	__iv__branch_expr = !(((signed int)(task_state[(signed long int)(i)]) == 2));
	printf("_tr_node_id:Node_12_272;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((signed int)(task_state[(signed long int)(i)]) == 2))) goto Node_12_275;
		tmp_if_expr = (1 != 0);
	printf("_tr_node_id:Node_12_273;_tr_assign:tmp_if_expr=%hhu;\n", tmp_if_expr);fflush(stdout);
	goto Node_12_276;
	Node_12_275:;
		tmp_if_expr = (((signed int)(task_state[(signed long int)(i)]) == 1) ? 1 : 0 != 0);
	printf("_tr_node_id:Node_12_275;_tr_assign:tmp_if_expr=%hhu;\n", tmp_if_expr);fflush(stdout);
	Node_12_276:;
	__iv__branch_expr = !tmp_if_expr;
	printf("_tr_node_id:Node_12_277;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!tmp_if_expr) goto Node_12_282;
	__iv__return_expr_is_active_obj_exists = 	1;
	printf("_tr_node_id:Node_12_278;_tr_assign:__iv__return_expr_is_active_obj_exists=%d;\n", __iv__return_expr_is_active_obj_exists);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	...
	Node_12_286:;
		i = 1;
	printf("_tr_node_id:Node_12_287;_tr_assign:i=%d;\n", i);fflush(stdout);
	Node_12_289:;
	__iv__branch_expr = (i >= 4);
	printf("_tr_node_id:Node_12_289;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((i >= 4)) goto Node_12_297;
	__iv__branch_expr = (alarm_state[(signed long int)(i)] == 0);
	printf("_tr_node_id:Node_12_290;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((alarm_state[(signed long int)(i)] == 0)) goto Node_12_294;
	__iv__return_expr_is_active_obj_exists = 	1;
	printf("_tr_node_id:Node_12_291;_tr_assign:__iv__return_expr_is_active_obj_exists=%d;\n", __iv__return_expr_is_active_obj_exists);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_is_active_obj_exists;
	Node_12_294:;
		i = (i + 1);
	...
	printf("_tr_node_id:Node_12_298;_tr_assign:__iv__return_expr_is_active_obj_exists=%d;\n", __iv__return_expr_is_active_obj_exists);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_is_active_obj_exists;
}
signed int is_active_alarm_exists() {
	printf("_tr_node_id:Node_13_302;_tr_decl:i;\n");fflush(stdout);
	signed int i;
		i = 1;
	printf("_tr_node_id:Node_13_303;_tr_assign:i=%d;\n", i);fflush(stdout);
	Node_13_305:;
	__iv__branch_expr = (i >= 4);
	printf("_tr_node_id:Node_13_305;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((i >= 4)) goto Node_13_313;
	__iv__branch_expr = (alarm_state[(signed long int)(i)] == 0);
	printf("_tr_node_id:Node_13_306;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((alarm_state[(signed long int)(i)] == 0)) goto Node_13_310;
	__iv__return_expr_is_active_alarm_exists = 	1;
	printf("_tr_node_id:Node_13_307;_tr_assign:__iv__return_expr_is_active_alarm_exists=%d;\n", __iv__return_expr_is_active_alarm_exists);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_is_active_alarm_exists;
	Node_13_310:;
		i = (i + 1);
	printf("_tr_node_id:Node_13_311;_tr_assign:i=%d;\n", i);fflush(stdout);
	goto Node_13_305;
	Node_13_313:;
	__iv__return_expr_is_active_alarm_exists = 	0;
	printf("_tr_node_id:Node_13_314;_tr_assign:__iv__return_expr_is_active_alarm_exists=%d;\n", __iv__return_expr_is_active_alarm_exists);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_is_active_alarm_exists;
}
signed int getX(U8 getX__rectindex) {
	printf("_tr_node_id:Node_14_318;_tr_decl:xul;\n");fflush(stdout);
	signed int xul;
		xul = (signed int)(nxtcamdata[(signed long int)((((5 * (signed int)(getX__rectindex)) + 1) + 1))]);
	printf("_tr_node_id:Node_14_319;_tr_assign:xul=%d;\n", xul);fflush(stdout);
	printf("_tr_node_id:Node_14_320;_tr_decl:xlr;\n");fflush(stdout);
	signed int xlr;
		xlr = (signed int)(nxtcamdata[(signed long int)((((5 * (signed int)(getX__rectindex)) + 1) + 3))]);
	printf("_tr_node_id:Node_14_321;_tr_assign:xlr=%d;\n", xlr);fflush(stdout);
	__iv__return_expr_getX = 	((xlr + xul) / 2);
	printf("_tr_node_id:Node_14_322;_tr_assign:__iv__return_expr_getX=%d;\n", __iv__return_expr_getX);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_getX;
}
signed int getWidth(U8 getWidth__rectindex) {
	printf("_tr_node_id:Node_15_327;_tr_decl:xul;\n");fflush(stdout);
	signed int xul;
		xul = (signed int)(nxtcamdata[(signed long int)((((5 * (signed int)(getWidth__rectindex)) + 1) + 1))]);
	printf("_tr_node_id:Node_15_328;_tr_assign:xul=%d;\n", xul);fflush(stdout);
	printf("_tr_node_id:Node_15_329;_tr_decl:xlr;\n");fflush(stdout);
	signed int xlr;
		xlr = (signed int)(nxtcamdata[(signed long int)((((5 * (signed int)(getWidth__rectindex)) + 1) + 3))]);
	printf("_tr_node_id:Node_15_330;_tr_assign:xlr=%d;\n", xlr);fflush(stdout);
	__iv__return_expr_getWidth = 	((xlr - xul) >= 0) ? (xlr - xul) : -((xlr - xul));
	printf("_tr_node_id:Node_15_331;_tr_assign:__iv__return_expr_getWidth=%d;\n", __iv__return_expr_getWidth);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_getWidth;
}
signed int getHeight(U8 getHeight__rectindex) {
	printf("_tr_node_id:Node_16_336;_tr_decl:yul;\n");fflush(stdout);
	signed int yul;
		yul = (signed int)(nxtcamdata[(signed long int)((((5 * (signed int)(getHeight__rectindex)) + 1) + 2))]);
	printf("_tr_node_id:Node_16_337;_tr_assign:yul=%d;\n", yul);fflush(stdout);
	printf("_tr_node_id:Node_16_338;_tr_decl:ylr;\n");fflush(stdout);
	signed int ylr;
		ylr = (signed int)(nxtcamdata[(signed long int)((((5 * (signed int)(getHeight__rectindex)) + 1) + 4))]);
	printf("_tr_node_id:Node_16_339;_tr_assign:ylr=%d;\n", ylr);fflush(stdout);
	__iv__return_expr_getHeight = 	((ylr - yul) >= 0) ? (ylr - yul) : -((ylr - yul));
	printf("_tr_node_id:Node_16_340;_tr_assign:__iv__return_expr_getHeight=%d;\n", __iv__return_expr_getHeight);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_getHeight;
}
void Func_AcquisitionTask() {
	__iv__branch_expr = (current_pc[1] == 1);
	printf("_tr_node_id:Node_17_346;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_17_348;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((current_pc[1] == 3)) goto Node_17_353;
	__iv__branch_expr = (current_pc[1] == 4);
	printf("_tr_node_id:Node_17_349;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_17_356;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (((signed int)(tracking_enabled) == 0)) goto Node_17_367;
	printf("_tr_node_id:Node_17_357;_tr_decl:return_value_send_nxtcam_command;\n");fflush(stdout);
	signed int return_value_send_nxtcam_command;
	printf("_tr_call:send_nxtcam_command;_tr_call_id:22;\n");fflush(stdout);
	...
	printf("_tr_node_id:Node_17_359;_tr_assign:return_value_send_nxtcam_command=%d;\n", return_value_send_nxtcam_command);fflush(stdout);
		tracking_enabled = (S8)(return_value_send_nxtcam_command);
	printf("_tr_node_id:Node_17_361;_tr_assign:tracking_enabled=%hhd;\n", tracking_enabled);fflush(stdout);
	goto Node_17_387;
	Node_17_367:;
	printf("_tr_call:request;_tr_call_id:23;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:port_id=%hhu;\n", (U8)(2));fflush(stdout);
	request((U8)(2));
	printf("_tr_call:__iv__getbiggestrect_stub;_tr_call_id:24;\n");fflush(stdout);
		rectindex = __iv__getbiggestrect_stub((U8)(0), -1);
	printf("_tr_node_id:Node_17_369;_tr_assign:rectindex=%d;\n", rectindex);fflush(stdout);
	__iv__branch_expr = !((rectindex >= 0));
	printf("_tr_node_id:Node_17_370;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((rectindex >= 0))) goto Node_17_387;
	printf("_tr_call:getArea;_tr_call_id:25;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:getArea__rectindex=%hhu;\n", (U8)(rectindex));fflush(stdout);
		area = getArea((U8)(rectindex));
	printf("_tr_node_id:Node_17_373;_tr_assign:area=%d;\n", area);fflush(stdout);
	printf("_tr_call:median_filter;_tr_call_id:26;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:datum=%d;\n", area);fflush(stdout);
		area = median_filter(area);
	printf("_tr_node_id:Node_17_374;_tr_assign:area=%d;\n", area);fflush(stdout);
	printf("_tr_call:fisqrt;_tr_call_id:27;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:val=%d;\n", area);fflush(stdout);
		acq_size = fisqrt(area);
	printf("_tr_node_id:Node_17_375;_tr_assign:acq_size=%d;\n", acq_size);fflush(stdout);
	printf("_tr_call:getX;_tr_call_id:28;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:getX__rectindex=%hhu;\n", (U8)(rectindex));fflush(stdout);
		x = getX((U8)(rectindex));
	printf("_tr_node_id:Node_17_376;_tr_assign:x=%d;\n", x);fflush(stdout);
	printf("_tr_call:GetResource;_tr_call_id:29;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", (unsigned char)(1));fflush(stdout);
	GetResource((unsigned char)(1));
	unsigned int __iv__index_expr_var3 = (unsigned) (1);
		current_pc[1] = 2;
	printf("_tr_node_id:Node_17_378;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var3, current_pc[__iv__index_expr_var3]);fflush(stdout);
	goto Node_17_393;
	Node_17_380:;
		objData.position = x;
	printf("_tr_node_id:Node_17_382;_tr_assign:objData.position=%d;\n", objData.position);fflush(stdout);
		objData.size = acq_size;
	printf("_tr_node_id:Node_17_383;_tr_assign:objData.size=%d;\n", objData.size);fflush(stdout);
	printf("_tr_call:ReleaseResource;_tr_call_id:30;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", (unsigned char)(1));fflush(stdout);
	ReleaseResource((unsigned char)(1));
	unsigned int __iv__index_expr_var4 = (unsigned) (1);
		current_pc[1] = 3;
	printf("_tr_node_id:Node_17_385;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var4, current_pc[__iv__index_expr_var4]);fflush(stdout);
	goto Node_17_393;
	Node_17_387:;
	printf("_tr_call:TerminateTask;_tr_call_id:31;\n");fflush(stdout);
	TerminateTask();
	unsigned int __iv__index_expr_var5 = (unsigned) (1);
		current_pc[1] = 4;
	printf("_tr_node_id:Node_17_389;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var5, current_pc[__iv__index_expr_var5]);fflush(stdout);
	goto Node_17_393;
	Node_17_391:;
	unsigned int __iv__index_expr_var6 = (unsigned) (1);
		current_pc[1] = 1;
	printf("_tr_node_id:Node_17_392;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var6, current_pc[__iv__index_expr_var6]);fflush(stdout);
	Node_17_393:;
	printf("_tr_return;\n");fflush(stdout);
}
signed int fisqrt(signed int val) {
	printf("_tr_node_id:Node_18_395;_tr_decl:cnt;\n");fflush(stdout);
	signed int cnt;
		cnt = 0;
	printf("_tr_node_id:Node_18_396;_tr_assign:cnt=%d;\n", cnt);fflush(stdout);
	printf("_tr_node_id:Node_18_397;_tr_decl:t;\n");fflush(stdout);
	signed int t;
		t = val;
	printf("_tr_node_id:Node_18_398;_tr_assign:t=%d;\n", t);fflush(stdout);
	Node_18_400:;
	__iv__branch_expr = (t == 0);
	printf("_tr_node_id:Node_18_400;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((t == 0)) goto Node_18_404;
		cnt = (cnt + 1);
	printf("_tr_node_id:Node_18_401;_tr_assign:cnt=%d;\n", cnt);fflush(stdout);
		t = (t >> 1);
	printf("_tr_node_id:Node_18_402;_tr_assign:t=%d;\n", t);fflush(stdout);
	goto Node_18_400;
	Node_18_404:;
	__iv__branch_expr = (cnt >= 7);
	printf("_tr_node_id:Node_18_405;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((cnt >= 7)) goto Node_18_408;
		t = (val << (6 - cnt));
	printf("_tr_node_id:Node_18_406;_tr_assign:t=%d;\n", t);fflush(stdout);
	goto Node_18_409;
	Node_18_408:;
		t = (val >> (cnt - 6));
	printf("_tr_node_id:Node_18_408;_tr_assign:t=%d;\n", t);fflush(stdout);
	Node_18_409:;
	__iv__return_expr_fisqrt = 	((ftbl[(signed long int)(cnt)] * ftbl2[(signed long int)((t & 31))]) >> 15);
	printf("_tr_node_id:Node_18_410;_tr_assign:__iv__return_expr_fisqrt=%d;\n", __iv__return_expr_fisqrt);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
	return __iv__return_expr_fisqrt;
}
signed int directionPIDController(signed int d) {
	printf("_tr_node_id:Node_19_415;_tr_decl:error;\n");fflush(stdout);
	signed int error;
		error = (83 - d);
	printf("_tr_node_id:Node_19_416;_tr_assign:error=%d;\n", error);fflush(stdout);
		integral = (integral + error);
	printf("_tr_node_id:Node_19_417;_tr_assign:integral=%d;\n", integral);fflush(stdout);
		prevError = error;
	printf("_tr_node_id:Node_19_418;_tr_assign:prevError=%d;\n", prevError);fflush(stdout);
	printf("_tr_return;\n");fflush(stdout);
}
void app() {
	printf("_tr_node_id:Node_20_422;_tr_decl:count;\n");fflush(stdout);
	signed int count;
		count = 0;
	printf("_tr_node_id:Node_20_423;_tr_assign:count=%d;\n", count);fflush(stdout);
	unsigned int __iv__index_expr_var7 = (unsigned) (1);
		current_pc[1] = 1;
	printf("_tr_node_id:Node_20_424;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var7, current_pc[__iv__index_expr_var7]);fflush(stdout);
	unsigned int __iv__index_expr_var8 = (unsigned) (2);
		current_pc[2] = 1;
	printf("_tr_node_id:Node_20_425;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var8, current_pc[__iv__index_expr_var8]);fflush(stdout);
	printf("_tr_node_id:Node_20_426;_tr_decl:return_value_is_active_obj_exists;\n");fflush(stdout);
	signed int return_value_is_active_obj_exists;
	Node_20_427:;
	printf("_tr_call:is_active_obj_exists;_tr_call_id:33;\n");fflush(stdout);
		return_value_is_active_obj_exists = is_active_obj_exists();
	printf("_tr_node_id:Node_20_427;_tr_assign:return_value_is_active_obj_exists=%d;\n", return_value_is_active_obj_exists);fflush(stdout);
	__iv__branch_expr = (return_value_is_active_obj_exists == 0);
	printf("_tr_node_id:Node_20_428;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((return_value_is_active_obj_exists == 0)) goto Node_20_449;
	__iv__branch_expr = !((os_on == ON));
	printf("_tr_node_id:Node_20_431;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((os_on == ON))) goto Node_20_449;
	__iv__branch_expr = (count >= 600);
	printf("_tr_node_id:Node_20_434;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((count >= 600)) goto Node_20_449;
	__iv__branch_expr = !(((signed int)(current_tid) == 1));
	printf("_tr_node_id:Node_20_437;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((signed int)(current_tid) == 1))) goto Node_20_440;
	printf("_tr_call:Func_AcquisitionTask;_tr_call_id:34;\n");fflush(stdout);
	Func_AcquisitionTask();
	goto Node_20_443;
	Node_20_440:;
	__iv__branch_expr = !(((signed int)(current_tid) == 2));
	printf("_tr_node_id:Node_20_440;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((signed int)(current_tid) == 2))) goto Node_20_442;
	printf("_tr_call:Func_ControlTask;_tr_call_id:35;\n");fflush(stdout);
	Func_ControlTask();
	Node_20_442:;
	Node_20_443:;
	printf("_tr_call:postjob;_tr_call_id:36;\n");fflush(stdout);
	postjob();
	printf("_tr_call:update_prop_automata;_tr_call_id:37;\n");fflush(stdout);
	update_prop_automata();
	printf("_tr_call:check_property;_tr_call_id:38;\n");fflush(stdout);
	check_property();
		count = (count + 1);
	printf("_tr_node_id:Node_20_447;_tr_assign:count=%d;\n", count);fflush(stdout);
	__iv__branch_expr = (1 != 0);
	printf("_tr_node_id:Node_20_448;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
...
signed int ActivateTask_Common(unsigned char reftask) {
	...
	printf("_tr_node_id:Node_21_453;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_21_456;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_21_457;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((signed int)(task_state[(signed long int)(reftask)]) == 0))) goto Node_21_467;
	printf("_tr_node_id:Node_21_458;_tr_decl:i;\n");fflush(stdout);
	signed int i;
		i = 0;
	printf("_tr_node_id:Node_21_459;_tr_assign:i=%d;\n", i);fflush(stdout);
	Node_21_461:;
	__iv__branch_expr = (i >= 3);
	printf("_tr_node_id:Node_21_461;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
...
void StartOS(unsigned char app_mode) {
	...
	printf("_tr_node_id:Node_27_493;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((os_on == OFF))) goto Node_27_498;
		os_on = ON;
	printf("_tr_node_id:Node_27_494;_tr_assign:os_on=%d;\n", os_on);fflush(stdout);
...
signed int GetResource_Common(unsigned char resid) {
	printf("_tr_node_id:Node_32_511;_tr_decl:return_value_is_alloc;\n");fflush(stdout);
	signed int return_value_is_alloc;
	printf("_tr_node_id:Node_32_512;_tr_decl:tmp_if_expr;\n");fflush(stdout);
	__CPROVER_bool tmp_if_expr;
	__iv__branch_expr = !((!(((signed int)(resid) >= 0)) || ((signed int)(resid) >= 3)));
	printf("_tr_node_id:Node_32_513;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((!(((signed int)(resid) >= 0)) || ((signed int)(resid) >= 3)))) goto Node_32_516;
	goto Node_32_531;
	Node_32_516:;
	printf("_tr_call:is_alloc;_tr_call_id:55;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:res=%hhu;\n", resid);fflush(stdout);
		return_value_is_alloc = is_alloc(resid);
	printf("_tr_node_id:Node_32_516;_tr_assign:return_value_is_alloc=%d;\n", return_value_is_alloc);fflush(stdout);
	__iv__branch_expr = !((return_value_is_alloc >= 1));
	printf("_tr_node_id:Node_32_517;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((return_value_is_alloc >= 1))) goto Node_32_520;
		tmp_if_expr = (1 != 0);
	printf("_tr_node_id:Node_32_518;_tr_assign:tmp_if_expr=%hhu;\n", tmp_if_expr);fflush(stdout);
	goto Node_32_521;
	Node_32_520:;
	...
	printf("_tr_node_id:Node_32_520;_tr_assign:tmp_if_expr=%hhu;\n", tmp_if_expr);fflush(stdout);
	Node_32_521:;
	__iv__branch_expr = !tmp_if_expr;
	printf("_tr_node_id:Node_32_522;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_32_526;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_32_527;_tr_assign:task_dyn_info[%u].dyn_prio=%hhu;\n", __iv__index_expr_var13, task_dyn_info[__iv__index_expr_var13].dyn_prio);fflush(stdout);
	Node_32_528:;
	Node_32_531:;
	printf("_tr_return;\n");fflush(stdout);
}
signed int ReleaseResource(unsigned char resid) {
	printf("_tr_call:ReleaseResource_Common;_tr_call_id:57;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", resid);fflush(stdout);
	ReleaseResource_Common(resid);
	printf("_tr_return;\n");fflush(stdout);
}
signed int GetResource(unsigned char resid) {
	printf("_tr_call:GetResource_Common;_tr_call_id:59;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", resid);fflush(stdout);
...
void ALARM_handler(signed int aid) {
	...
	printf("_tr_node_id:Node_36_545;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_36_556;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((signed int)(alarm_info[(signed long int)(aid)].api) == 6))) goto Node_36_558;
	printf("_tr_call:SetEvent_Common;_tr_call_id:63;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:reftask=%hhu;\n", alarm_info[(signed long int)(aid)].param1);fflush(stdout);
	...
	printf("_tr_node_id:Node_36_560;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
...
void Func_ControlTask() {
	...
	printf("_tr_node_id:Node_37_568;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((current_pc[2] == 1)) goto Node_37_573;
	__iv__branch_expr = (current_pc[2] == 2);
	printf("_tr_node_id:Node_37_569;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((current_pc[2] == 2)) goto Node_37_574;
	__iv__branch_expr = (current_pc[2] == 3);
	printf("_tr_node_id:Node_37_570;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((current_pc[2] == 3)) goto Node_37_575;
	__iv__branch_expr = (current_pc[2] == 4);
	printf("_tr_node_id:Node_37_571;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	goto Node_37_599;
	Node_37_577:;
	printf("_tr_call:GetResource;_tr_call_id:64;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", (unsigned char)(1));fflush(stdout);
	GetResource((unsigned char)(1));
	unsigned int __iv__index_expr_var19 = (unsigned) (2);
		current_pc[2] = 2;
	printf("_tr_node_id:Node_37_579;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var19, current_pc[__iv__index_expr_var19]);fflush(stdout);
	goto Node_37_601;
	Node_37_581:;
		data = objData;
	printf("_tr_node_id:Node_37_583;_tr_dynamic_assign:	data = objData;\n");fflush(stdout);
	printf("_tr_call:ReleaseResource;_tr_call_id:65;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", (unsigned char)(1));fflush(stdout);
	ReleaseResource((unsigned char)(1));
	unsigned int __iv__index_expr_var20 = (unsigned) (2);
		current_pc[2] = 3;
	printf("_tr_node_id:Node_37_585;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var20, current_pc[__iv__index_expr_var20]);fflush(stdout);
	goto Node_37_601;
	Node_37_587:;
		ctl_size = data.size;
	printf("_tr_node_id:Node_37_588;_tr_assign:ctl_size=%d;\n", ctl_size);fflush(stdout);
		position = data.position;
	printf("_tr_node_id:Node_37_589;_tr_assign:position=%d;\n", position);fflush(stdout);
	__iv__branch_expr = !(((ctl_size >= 1) && (position >= 1)));
	printf("_tr_node_id:Node_37_590;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((ctl_size >= 1) && (position >= 1)))) goto Node_37_595;
	printf("_tr_call:speedPIDController;_tr_call_id:66;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:d=%d;\n", ctl_size);fflush(stdout);
		speed_deviation = speedPIDController(ctl_size);
	printf("_tr_node_id:Node_37_591;_tr_assign:speed_deviation=%d;\n", speed_deviation);fflush(stdout);
		new_speed = (50 + speed_deviation);
	printf("_tr_node_id:Node_37_592;_tr_assign:new_speed=%d;\n", new_speed);fflush(stdout);
		new_speed = (new_speed > 100) ? 100 : new_speed;
	printf("_tr_node_id:Node_37_593;_tr_assign:new_speed=%d;\n", new_speed);fflush(stdout);
	printf("_tr_call:directionPIDController;_tr_call_id:67;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:d=%d;\n", position);fflush(stdout);
	directionPIDController(position);
	Node_37_595:;
	printf("_tr_call:TerminateTask;_tr_call_id:68;\n");fflush(stdout);
	TerminateTask();
	unsigned int __iv__index_expr_var21 = (unsigned) (2);
		current_pc[2] = 4;
	printf("_tr_node_id:Node_37_597;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var21, current_pc[__iv__index_expr_var21]);fflush(stdout);
	goto Node_37_601;
	Node_37_599:;
	unsigned int __iv__index_expr_var22 = (unsigned) (2);
		current_pc[2] = 1;
	printf("_tr_node_id:Node_37_600;_tr_assign:current_pc[%u]=%d;\n", __iv__index_expr_var22, current_pc[__iv__index_expr_var22]);fflush(stdout);
	Node_37_601:;
	printf("_tr_return;\n");fflush(stdout);
}
signed int SetEvent_Common(unsigned char reftask, unsigned char eventid) {
	__iv__branch_expr = !((!(((signed int)(reftask) >= 1)) || ((signed int)(reftask) >= 5)));
	printf("_tr_node_id:Node_38_603;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_38_606;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!(((signed int)(task_static_info[(signed long int)(reftask)].extended) == 0))) goto Node_38_609;
	goto Node_38_621;
	Node_38_609:;
	__iv__branch_expr = ((signed int)(task_state[(signed long int)(reftask)]) == 0);
	printf("_tr_node_id:Node_38_609;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_38_614;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
...
signed int ActivateTask(unsigned char reftask) {
	printf("_tr_call:ActivateTask_Common;_tr_call_id:75;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:reftask=%hhu;\n", reftask);fflush(stdout);
...
signed int Schedule() {
	printf("_tr_call:Schedule_Common;_tr_call_id:78;\n");fflush(stdout);
	Schedule_Common();
	printf("_tr_return;\n");fflush(stdout);
}
signed int TerminateTask_Common() {
	__iv__branch_expr = !(((signed int)(task_dyn_info[(signed long int)(current_tid)].act_cnt) >= 1));
	printf("_tr_node_id:Node_45_714;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_45_715;_tr_assign:task_dyn_info[%u].act_cnt=%hhu;\n", __iv__index_expr_var25, task_dyn_info[__iv__index_expr_var25].act_cnt);fflush(stdout);
	Node_45_716:;
	__iv__branch_expr = !(((signed int)(task_dyn_info[(signed long int)(current_tid)].act_cnt) >= 1));
	printf("_tr_node_id:Node_45_717;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_45_720;_tr_assign:task_state[%u]=%hhu;\n", __iv__index_expr_var27, task_state[__iv__index_expr_var27]);fflush(stdout);
	Node_45_721:;
	printf("_tr_call:reschedule;_tr_call_id:80;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:reschedule__api=%d;\n", (API)(1));fflush(stdout);
	printf("_tr_param;_tr_assign:tid=%hhu;\n", current_tid);fflush(stdout);
...
signed int ChainTask(unsigned char reftask) {
	printf("_tr_call:ChainTask_Common;_tr_call_id:82;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:reftask=%hhu;\n", reftask);fflush(stdout);
...
void update_prop_automata() {
	...
	printf("_tr_node_id:Node_50_736;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((state == 0))) goto Node_50_742;
		counter = 0;
	printf("_tr_node_id:Node_50_737;_tr_assign:counter=%d;\n", counter);fflush(stdout);
	__iv__branch_expr = !((ctl_size >= 84));
	printf("_tr_node_id:Node_50_738;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((ctl_size >= 84))) goto Node_50_740;
		state = 1;
	printf("_tr_node_id:Node_50_739;_tr_assign:state=%d;\n", state);fflush(stdout);
	Node_50_740:;
	goto Node_50_752;
	Node_50_742:;
	__iv__branch_expr = !((state == 1));
	printf("_tr_node_id:Node_50_742;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((state == 1))) goto Node_50_751;
		counter = (counter + 1);
	printf("_tr_node_id:Node_50_743;_tr_assign:counter=%d;\n", counter);fflush(stdout);
	__iv__branch_expr = (new_speed >= 0);
	printf("_tr_node_id:Node_50_744;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((new_speed >= 0)) goto Node_50_747;
		state = 0;
	printf("_tr_node_id:Node_50_745;_tr_assign:state=%d;\n", state);fflush(stdout);
	goto Node_50_750;
	Node_50_747:;
	__iv__branch_expr = !((counter >= 10));
	printf("_tr_node_id:Node_50_747;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((counter >= 10))) goto Node_50_749;
		state = 2;
	printf("_tr_node_id:Node_50_748;_tr_assign:state=%d;\n", state);fflush(stdout);
	Node_50_749:;
	Node_50_750:;
	Node_50_751:;
	Node_50_752:;
...
void startup_process() {
	printf("_tr_node_id:Node_54_762;_tr_decl:i;\n");fflush(stdout);
	unsigned int i;
		i = 0u;
	printf("_tr_node_id:Node_54_763;_tr_assign:i=%u;\n", i);fflush(stdout);
	Node_54_765:;
	...
	printf("_tr_node_id:Node_54_766;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_54_767;_tr_assign:task_dyn_info[%u].act_cnt=%hhu;\n", __iv__index_expr_var28, task_dyn_info[__iv__index_expr_var28].act_cnt);fflush(stdout);
		current_prio = task_static_info[(signed long int)(i)].prio;
	printf("_tr_node_id:Node_54_768;_tr_assign:current_prio=%hhu;\n", current_prio);fflush(stdout);
	printf("_tr_call:push_task_into_readyQ;_tr_call_id:88;\n");fflush(stdout);
	...
	printf("_tr_node_id:Node_54_770;_tr_assign:task_state[%u]=%hhu;\n", __iv__index_expr_var29, task_state[__iv__index_expr_var29]);fflush(stdout);
	Node_54_771:;
		i = (i + 1u);
	printf("_tr_node_id:Node_54_772;_tr_assign:i=%u;\n", i);fflush(stdout);
	goto Node_54_765;
	Node_54_774:;
	__iv__branch_expr = (wholesize == 0);
	printf("_tr_node_id:Node_54_775;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((wholesize == 0)) goto Node_54_778;
	printf("_tr_call:get_task_from_readyQ;_tr_call_id:89;\n");fflush(stdout);
...
object_data_t getData() {
	printf("_tr_call:GetResource;_tr_call_id:90;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", (unsigned char)(1));fflush(stdout);
	GetResource((unsigned char)(1));
	printf("_tr_call:ReleaseResource;_tr_call_id:91;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:resid=%hhu;\n", (unsigned char)(1));fflush(stdout);
	ReleaseResource((unsigned char)(1));
	printf("_tr_return;\n");fflush(stdout);
}
void get_task_from_readyQ() {
	__iv__branch_expr = !((wholesize == 0));
	printf("_tr_node_id:Node_62_797;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (!((wholesize == 0))) goto Node_62_801;
		current_tid = (unsigned char)(0);
	printf("_tr_node_id:Node_62_798;_tr_assign:current_tid=%hhu;\n", current_tid);fflush(stdout);
		current_prio = (unsigned char)(0);
	printf("_tr_node_id:Node_62_799;_tr_assign:current_prio=%hhu;\n", current_prio);fflush(stdout);
	goto Node_62_817;
	Node_62_801:;
		current_tid = readyQ[(signed long int)(max_prio)][(signed long int)(front[(signed long int)(max_prio)])].tid;
	printf("_tr_node_id:Node_62_801;_tr_assign:current_tid=%hhu;\n", current_tid);fflush(stdout);
		current_prio = max_prio;
	printf("_tr_node_id:Node_62_802;_tr_assign:current_prio=%hhu;\n", current_prio);fflush(stdout);
...
void push_task_into_readyQ(unsigned char t, unsigned char p, signed int pc, push_type pushkind) {
	...
	printf("_tr_node_id:Node_70_864;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if ((size[(signed long int)(p)] == 3)) goto Node_70_881;
	__iv__branch_expr = !(((signed int)(pushkind) == 1));
	printf("_tr_node_id:Node_70_865;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
...
signed int reschedule(API reschedule__api, unsigned char tid) {
	...
	printf("_tr_node_id:Node_71_883;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_71_887;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	...
	printf("_tr_node_id:Node_71_890;_tr_assign:__iv__branch_expr=%d;\n", __iv__branch_expr);fflush(stdout);
	if (((signed int)(task_dyn_info[(signed long int)(tid)].dyn_prio) >= (signed int)(max_prio))) goto Node_71_893;
	printf("_tr_call:push_task_into_readyQ;_tr_call_id:94;\n");fflush(stdout);
	printf("_tr_param;_tr_assign:t=%hhu;\n", tid);fflush(stdout);
	...
	printf("_tr_call:get_task_from_readyQ;_tr_call_id:95;\n");fflush(stdout);
	get_task_from_readyQ();
	Node_71_893:;
	Node_71_896:;
	printf("_tr_return;\n");fflush(stdout);
