...
void app() {
	...
	Node_20_427:;
__iv__current_func_call = 33;	return_value_is_active_obj_exists = is_active_obj_exists();
...
__iv__current_func_call = 34;	Func_AcquisitionTask();
	goto Node_20_443;
	Node_20_440:;
	if (!(((signed int)(current_tid) == 2))) goto Node_20_442;
__iv__current_func_call = 35;	Func_ControlTask();
	Node_20_442:;
	Node_20_443:;
__iv__current_func_call = 36;	postjob();
__iv__current_func_call = 37;	update_prop_automata();
...
__iv__current_func_call = 67;	directionPIDController(position);
	Node_37_595:;
...
__iv__current_func_call = 88;	push_task_into_readyQ((unsigned char)(i), current_prio, 0, (push_type)(0));
...
__iv__current_func_call = 89;	get_task_from_readyQ();
...
object_data_t getData() {
__iv__current_func_call = 90;	GetResource((unsigned char)(1));
__iv__current_func_call = 91;	ReleaseResource((unsigned char)(1));
	// End of Function
}
void get_task_from_readyQ() {
...
__iv__current_func_call = 94;	push_task_into_readyQ(tid, task_dyn_info[(signed long int)(tid)].dyn_prio, current_pc[(signed long int)(tid)], (push_type)(1));
__iv__current_func_call = 95;	get_task_from_readyQ();
	Node_71_893:;
	Node_71_896:;
	// End of Function
}
