...
__iv__current_func_call = 9;	getbiggestrect__1__1__1__1__area = getArea((U8)(i));
...
signed int ReleaseResource_Common(unsigned char resid) {
	...
	goto Node_6_143;
	Node_6_110:;
__iv__current_func_call = 10;	return_value_is_alloc_0 = is_alloc(resid);
...
__iv__current_func_call = 11;	return_value_is_alloc = is_alloc(i);
...
__iv__current_func_call = 12;	reschedule((API)(5), current_tid);
	goto Node_6_143;
	Node_6_143:;
	// End of Function
}
...
__iv__current_func_call = 14;	return_value_is_active_alarm_exists = is_active_alarm_exists();
...
__iv__current_func_call = 15;	ALARM_handler(aid);
	Node_7_159:;
	aid = (aid + 1);
	goto Node_7_156;
	Node_7_162:;
...
__iv__current_func_call = 17;	return_value_getWidth = getWidth(getArea__rectindex);
	signed int return_value_getHeight;
__iv__current_func_call = 18;	return_value_getHeight = getHeight(getArea__rectindex);
...
signed int GetResource_Common(unsigned char resid) {
	...
	goto Node_15_341;
	Node_15_326:;
__iv__current_func_call = 19;	return_value_is_alloc = is_alloc(resid);
...
void app() {
	...
	Node_17_354:;
__iv__current_func_call = 22;	return_value_is_active_obj_exists = is_active_obj_exists();
...
__iv__current_func_call = 23;	Func_AcquisitionTask();
	goto Node_17_370;
	Node_17_367:;
	if (!(((signed int)(current_tid) == 2))) goto Node_17_369;
__iv__current_func_call = 24;	Func_ControlTask();
	Node_17_369:;
	Node_17_370:;
__iv__current_func_call = 25;	postjob();
__iv__current_func_call = 26;	check_property();
	count = (count + 1);
...
__iv__current_func_call = 27;	push_task_into_readyQ((unsigned char)(i), current_prio, 0, (push_type)(0));
...
__iv__current_func_call = 28;	get_task_from_readyQ();
...
signed int WaitEvent(unsigned char eventid) {
__iv__current_func_call = 30;	WaitEvent_Common(eventid);
	// End of Function
}
signed int TerminateTask() {
__iv__current_func_call = 32;	TerminateTask_Common();
	// End of Function
}
void StartOS(unsigned char app_mode) {
	if (!((os_on == OFF))) goto Node_22_414;
	os_on = ON;
__iv__current_func_call = 34;	initialize();
__iv__current_func_call = 35;	startup_process();
__iv__current_func_call = 36;	app();
	Node_22_414:;
	// End of Function
}
void ShutDownOS() {
...
signed int SetEvent(unsigned char reftask, unsigned char eventid) {
__iv__current_func_call = 39;	SetEvent_Common(reftask, eventid);
	// End of Function
}
signed int ReleaseResource(unsigned char resid) {
__iv__current_func_call = 41;	ReleaseResource_Common(resid);
	// End of Function
}
signed int GetResource(unsigned char resid) {
__iv__current_func_call = 43;	GetResource_Common(resid);
	// End of Function
}
void Func_AcquisitionTask() {
...
__iv__current_func_call = 45;	return_value_send_nxtcam_command = send_nxtcam_command((U8)(2), (U8)(69));
	tracking_enabled = (S8)(return_value_send_nxtcam_command);
	goto Node_29_473;
	Node_29_455:;
__iv__current_func_call = 46;	request((U8)(2));
__iv__current_func_call = 47;	rectindex = getbiggestrect((U8)(0), -1);
	if (!((rectindex >= 0))) goto Node_29_473;
__iv__current_func_call = 48;	area = getArea((U8)(rectindex));
__iv__current_func_call = 49;	area = median_filter(area);
__iv__current_func_call = 50;	acq_size = fisqrt(area);
__iv__current_func_call = 51;	x = getX((U8)(rectindex));
...
signed int Schedule() {
__iv__current_func_call = 70;	Schedule_Common();
	// End of Function
}
signed int TerminateTask_Common() {
	...
	Node_41_651:;
__iv__current_func_call = 72;	reschedule((API)(1), current_tid);
	// End of Function
}
signed int fisqrt(signed int val) {
	signed int cnt;
...
signed int ChainTask(unsigned char reftask) {
__iv__current_func_call = 74;	ChainTask_Common(reftask);
	// End of Function
}
signed int ActivateTask_Common(unsigned char reftask) {
...
__iv__current_func_call = 76;	push_task_into_readyQ(reftask, task_static_info[(signed long int)(reftask)].prio, 0, (push_type)(0));
__iv__current_func_call = 77;	reschedule((API)(0), current_tid);
	Node_44_696:;
	Node_44_698:;
	// End of Function
}
...
signed int request(U8 port_id) {
	signed int return_value_i2c_busy;
__iv__current_func_call = 81;	return_value_i2c_busy = i2c_busy((signed int)(port_id));
	if (!((return_value_i2c_busy == 0))) goto Node_48_715;
__iv__current_func_call = 82;	i2c_start_transaction((signed int)(port_id), 1u, 0x42, 1, nxtcamdata, 41u, 0);
	Node_48_715:;
	// End of Function
}
void update_prop_automata() {
