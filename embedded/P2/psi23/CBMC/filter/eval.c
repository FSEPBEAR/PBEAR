...
void update_prop_automata() {
	...
	timer = clock();
	if (!((orderMatrix[1][(signed long int)(myFloor)] == 1))) goto Node_8_292;
	state = 1;
	Node_8_292:;
	goto Node_8_306;
	Node_8_294:;
	if (!((state == 1))) goto Node_8_305;
	if (!((orderMatrix[1][(signed long int)(myFloor)] == 0) ? TRUE : ((previousMainFloor == myFloor) && ((signed int)(previousState) == 3)) ? TRUE : FALSE)) goto Node_8_300;
	state = 0;
	goto Node_8_304;
	Node_8_300:;
...
void check_property() {
	...
	if(!((state != 2))) printf("vioated property: Node_28_705\n"); fflush(stdout);
	assert((state != 2));
	// End of Function
}
void io_set_bit(signed int channel) {
