...
signed int setDirection(signed int currentFloor, signed int lastDirection) {
	...
	currentFloor = (signed int)(((int)(currentFloor) + ((int)(lastDirection) / 2)));
	Node_9_334:;
	signed int upOrders;
	upOrders = 0;
...
signed int getTimerStatus() {
	...
	deltaTime = ((long int)((return_value_clock - timerStarted)) / 1);
	if (!(((deltaTime >= (long int)(duration)) && !((timerActive == 0))))) goto Node_13_483;
	return 1;
	Node_13_483:;
	return 0;
}
