...
__iv__current_func_call = 5;	return_value_elev_init = elev_init();
	if ((return_value_elev_init == 0)) goto Node_0_17;
__iv__current_func_call = 6;	initStates();
	Node_0_11:;
	if (!((1 != 0))) goto Node_0_16;
__iv__current_func_call = 7;	stateController();
__iv__current_func_call = 8;	update_prop_automata();
__iv__current_func_call = 9;	check_property();
	goto Node_0_11;
	Node_0_16:;
	Node_0_17:;
	// End of Function
...
__iv__current_func_call = 11;	return_value_elev_get_floor_sensor_signal_0 = elev_get_floor_sensor_signal();
	if (!((return_value_elev_get_floor_sensor_signal_0 == -1))) goto Node_1_35;
__iv__current_func_call = 12;	elev_set_motor_direction((elev_motor_direction_t)(1));
	Node_1_29:;
__iv__current_func_call = 13;	return_value_elev_get_floor_sensor_signal = elev_get_floor_sensor_signal();
	if (!((return_value_elev_get_floor_sensor_signal == -1))) goto Node_1_34;
	if ((1 != 0)) goto Node_1_29;
	Node_1_34:;
	Node_1_35:;
__iv__current_func_call = 14;	elev_set_motor_direction((elev_motor_direction_t)(0));
...
__iv__current_func_call = 15;	return_value_io_init = io_init();
...
__iv__current_func_call = 16;	elev_set_button_lamp((elev_button_type_t)(1), i, 0);
	Node_2_60:;
	if ((i == 3)) goto Node_2_63;
__iv__current_func_call = 17;	elev_set_button_lamp((elev_button_type_t)(0), i, 0);
	Node_2_63:;
__iv__current_func_call = 18;	elev_set_button_lamp((elev_button_type_t)(2), i, 0);
	i = (i + 1);
	goto Node_2_57;
	Node_2_67:;
__iv__current_func_call = 19;	elev_set_floor_indicator(0);
	return 1;
}
signed int elev_get_floor_sensor_signal() {
	signed int return_value_isTimerActive;
__iv__current_func_call = 20;	return_value_isTimerActive = isTimerActive();
	if ((return_value_isTimerActive == 0)) goto Node_3_111;
	if ((elev_motor == 0)) goto Node_3_110;
	signed int return_value_getTimerStatus;
__iv__current_func_call = 21;	return_value_getTimerStatus = getTimerStatus();
	if ((return_value_getTimerStatus == 0)) goto Node_3_101;
__iv__current_func_call = 22;	timerDeactivate();
...
void stateController() {
__iv__current_func_call = 26;	setOrdersHigh();
__iv__current_func_call = 27;	currentFloorLocation = elev_get_floor_sensor_signal();
	...
	Node_5_143:;
__iv__current_func_call = 28;	elev_set_floor_indicator(previousMainFloor);
	...
	goto Node_5_195;
	Node_5_153:;
__iv__current_func_call = 29;	return_value_isButtonPressed = isButtonPressed();
	if ((return_value_isButtonPressed == 0)) goto Node_5_158;
__iv__current_func_call = 30;	motorDirection = setDirection(previousMainFloor, motorDirection);
__iv__current_func_call = 31;	elev_set_motor_direction((elev_motor_direction_t)(motorDirection));
	previousState = (elevState)(2);
	Node_5_158:;
	goto Node_5_195;
	Node_5_160:;
__iv__current_func_call = 32;	return_value_floorIsOrdered = floorIsOrdered(previousMainFloor, motorDirection);
	...
	goto Node_5_195;
	Node_5_166:;
__iv__current_func_call = 33;	elev_set_motor_direction((elev_motor_direction_t)(0));
	motorDirection = 0;
__iv__current_func_call = 34;	return_value_isTimerActive = isTimerActive();
	if (!((return_value_isTimerActive == 0))) goto Node_5_174;
__iv__current_func_call = 35;	return_value_elev_get_floor_sensor_signal = elev_get_floor_sensor_signal();
	if ((return_value_elev_get_floor_sensor_signal == -1)) goto Node_5_173;
__iv__current_func_call = 36;	startTimer(3.0);
	Node_5_173:;
	Node_5_174:;
__iv__current_func_call = 37;	return_value_isTimerActive_0 = isTimerActive();
	if (!((return_value_isTimerActive_0 == 1))) goto Node_5_187;
	signed int return_value_floorIsOrdered_0;
__iv__current_func_call = 38;	return_value_floorIsOrdered_0 = floorIsOrdered(previousMainFloor, motorDirection);
	if ((return_value_floorIsOrdered_0 == 0)) goto Node_5_184;
__iv__current_func_call = 39;	startTimer(3.0);
__iv__current_func_call = 40;	removeFromOrderMatrix(previousMainFloor);
	Node_5_184:;
	Node_5_187:;
__iv__current_func_call = 41;	return_value_getTimerStatus = getTimerStatus();
	if ((return_value_getTimerStatus == 0)) goto Node_5_192;
	previousState = (elevState)(1);
__iv__current_func_call = 42;	timerDeactivate();
	Node_5_192:;
	goto Node_5_195;
	Node_5_194:;
	Node_5_195:;
...
__iv__current_func_call = 43;	return_value_elev_get_stop_signal = elev_get_stop_signal();
	if ((return_value_elev_get_stop_signal == 0)) goto Node_5_215;
	__CPROVER_assume((0 != 0));
	signed int return_value_emergencyStopHandler;
__iv__current_func_call = 45;	return_value_emergencyStopHandler = emergencyStopHandler();
...
signed int emergencyStopHandler() {
	...
	Node_6_241:;
	currentState = (elevState)(-1);
__iv__current_func_call = 46;	elev_set_motor_direction((elev_motor_direction_t)(0));
	goto Node_6_278;
	Node_6_244:;
	currentState = (elevState)(-1);
__iv__current_func_call = 47;	elev_set_motor_direction((elev_motor_direction_t)(0));
__iv__current_func_call = 48;	return_value_elev_get_floor_sensor_signal = elev_get_floor_sensor_signal();
	...
	goto Node_6_278;
	Node_6_254:;
__iv__current_func_call = 49;	flushOrders();
__iv__current_func_call = 50;	elev_set_motor_direction((elev_motor_direction_t)(0));
	Node_6_256:;
__iv__current_func_call = 51;	return_value_elev_get_stop_signal = elev_get_stop_signal();
...
__iv__current_func_call = 53;	return_value_io_read_bit = io_read_bit((0x300 + 22));
...
__iv__current_func_call = 54;	return_value_elev_get_button_signal = elev_get_button_signal((elev_button_type_t)(button), floorNum);
	if ((return_value_elev_get_button_signal == 0)) goto Node_8_314;
	orderMatrix[(signed long int)(button)][(signed long int)(floorNum)] = 1;
__iv__current_func_call = 55;	elev_set_button_lamp((elev_button_type_t)(button), floorNum, 1);
	Node_8_314:;
	floorNum = (floorNum + 1);
	goto Node_8_306;
	Node_8_319:;
...
signed int setDirection(signed int currentFloor, signed int lastDirection) {
	...
	signed int return_value_elev_get_floor_sensor_signal;
__iv__current_func_call = 58;	return_value_elev_get_floor_sensor_signal = elev_get_floor_sensor_signal();
...
signed int io_read_bit(signed int channel) {
	unsigned int data;
	data = 0u;
__iv__current_func_call = 59;	comedi_dio_read(it_g, (channel >> 8), (channel & 0xFF), (signed int*)(&data));
...
signed int io_init() {
	...
	signed int status;
	status = 0;
__iv__current_func_call = 60;	it_g = comedi_open("/dev/comedi0");
...
__iv__current_func_call = 61;	return_value_comedi_dio_config = comedi_dio_config(it_g, 2, i, 0);
	status = (status | return_value_comedi_dio_config);
	signed int return_value_comedi_dio_config_0;
__iv__current_func_call = 62;	return_value_comedi_dio_config_0 = comedi_dio_config(it_g, 3, i, 1);
	status = (status | return_value_comedi_dio_config_0);
	signed int return_value_comedi_dio_config_1;
__iv__current_func_call = 63;	return_value_comedi_dio_config_1 = comedi_dio_config(it_g, 3, (i + 8), 1);
	status = (status | return_value_comedi_dio_config_1);
	signed int return_value_comedi_dio_config_2;
__iv__current_func_call = 64;	return_value_comedi_dio_config_2 = comedi_dio_config(it_g, 3, (i + 16), 0);
...
__iv__current_func_call = 65;	return_value_clock = clock();
...
__iv__current_func_call = 66;	elev_set_button_lamp((elev_button_type_t)(button), floorNum, 0);
	floorNum = (floorNum + 1);
	goto Node_14_501;
	Node_14_506:;
	button = (button + 1);
...
signed int elev_get_button_signal(elev_button_type_t button, signed int floor) {
	...
	signed int return_value_io_read_bit;
__iv__current_func_call = 70;	return_value_io_read_bit = io_read_bit(button_channel_matrix[(signed long int)(floor)][(signed long int)(button)]);
...
void startTimer(double length) {
__iv__current_func_call = 73;	timerStarted = clock();
	duration = length;
	timerActive = 1;
	// End of Function
}
...
void removeFromOrderMatrix(signed int floorNum) {
	...
	orderMatrix[(signed long int)(button)][(signed long int)(floorNum)] = 0;
__iv__current_func_call = 76;	elev_set_button_lamp((elev_button_type_t)(button), floorNum, 0);
	button = (button + 1);
	goto Node_32_723;
	Node_32_728:;
	// End of Function
...
__iv__current_func_call = 77;	io_read_bit((0x300 + 23));
	// End of Function
}
void elev_set_button_lamp(elev_button_type_t button, signed int floor, signed int value) {
	__CPROVER_assume((floor >= 0));
...
__iv__current_func_call = 84;	startTimer(3.0);
	...
	elev_motor = -1;
__iv__current_func_call = 85;	startTimer(3.0);
	Node_39_794:;
	Node_39_795:;
	Node_39_796:;
	// End of Function
