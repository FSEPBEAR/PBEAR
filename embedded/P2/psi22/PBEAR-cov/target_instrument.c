...
__iv__current_func_call = 2;	return_value_elev_init = elev_init();
	if ((return_value_elev_init == 0)) goto Node_0_14;
__iv__current_func_call = 3;	initStates();
	Node_0_8:;
	if (!((1 != 0))) goto Node_0_13;
__iv__current_func_call = 4;	stateController();
__iv__current_func_call = 5;	update_prop_automata();
__iv__current_func_call = 6;	check_property();
	goto Node_0_8;
	Node_0_13:;
	Node_0_14:;
	// End of Function
...
void stateController() {
__iv__current_func_call = 8;	setOrdersHigh();
__iv__current_func_call = 9;	currentFloorLocation = elev_get_floor_sensor_signal();
	...
	Node_1_32:;
__iv__current_func_call = 10;	elev_set_floor_indicator(previousMainFloor);
	...
	goto Node_1_84;
	Node_1_42:;
__iv__current_func_call = 11;	return_value_isButtonPressed = isButtonPressed();
	if ((return_value_isButtonPressed == 0)) goto Node_1_47;
__iv__current_func_call = 12;	motorDirection = setDirection(previousMainFloor, motorDirection);
__iv__current_func_call = 13;	elev_set_motor_direction((elev_motor_direction_t)(motorDirection));
	previousState = (elevState)(2);
	Node_1_47:;
	goto Node_1_84;
	Node_1_49:;
__iv__current_func_call = 14;	return_value_floorIsOrdered = floorIsOrdered(previousMainFloor, motorDirection);
	...
	goto Node_1_84;
	Node_1_55:;
__iv__current_func_call = 15;	elev_set_motor_direction((elev_motor_direction_t)(0));
	motorDirection = 0;
__iv__current_func_call = 16;	return_value_isTimerActive = isTimerActive();
	if (!((return_value_isTimerActive == 0))) goto Node_1_63;
__iv__current_func_call = 17;	return_value_elev_get_floor_sensor_signal = elev_get_floor_sensor_signal();
	if ((return_value_elev_get_floor_sensor_signal == -1)) goto Node_1_62;
__iv__current_func_call = 18;	startTimer(3.0);
	Node_1_62:;
	Node_1_63:;
__iv__current_func_call = 19;	return_value_isTimerActive_0 = isTimerActive();
	if (!((return_value_isTimerActive_0 == 1))) goto Node_1_76;
	signed int return_value_floorIsOrdered_0;
__iv__current_func_call = 20;	return_value_floorIsOrdered_0 = floorIsOrdered(previousMainFloor, motorDirection);
	if ((return_value_floorIsOrdered_0 == 0)) goto Node_1_73;
__iv__current_func_call = 21;	startTimer(3.0);
__iv__current_func_call = 22;	removeFromOrderMatrix(previousMainFloor);
	Node_1_73:;
	Node_1_76:;
__iv__current_func_call = 23;	return_value_getTimerStatus = getTimerStatus();
	if ((return_value_getTimerStatus == 0)) goto Node_1_81;
	previousState = (elevState)(1);
__iv__current_func_call = 24;	timerDeactivate();
	Node_1_81:;
	goto Node_1_84;
	Node_1_83:;
	Node_1_84:;
...
__iv__current_func_call = 25;	return_value_elev_get_stop_signal = elev_get_stop_signal();
	if ((return_value_elev_get_stop_signal == 0)) goto Node_1_104;
	__CPROVER_assume((0 != 0));
	signed int return_value_emergencyStopHandler;
__iv__current_func_call = 27;	return_value_emergencyStopHandler = emergencyStopHandler();
...
signed int setDirection(signed int currentFloor, signed int lastDirection) {
	...
	signed int return_value_elev_get_floor_sensor_signal;
__iv__current_func_call = 30;	return_value_elev_get_floor_sensor_signal = elev_get_floor_sensor_signal();
...
signed int io_init() {
	...
	signed int status;
	status = 0;
__iv__current_func_call = 31;	it_g = comedi_open("/dev/comedi0");
...
__iv__current_func_call = 32;	return_value_comedi_dio_config = comedi_dio_config(it_g, 2, i, 0);
	status = (status | return_value_comedi_dio_config);
	signed int return_value_comedi_dio_config_0;
__iv__current_func_call = 33;	return_value_comedi_dio_config_0 = comedi_dio_config(it_g, 3, i, 1);
	status = (status | return_value_comedi_dio_config_0);
	signed int return_value_comedi_dio_config_1;
__iv__current_func_call = 34;	return_value_comedi_dio_config_1 = comedi_dio_config(it_g, 3, (i + 8), 1);
	status = (status | return_value_comedi_dio_config_1);
	signed int return_value_comedi_dio_config_2;
__iv__current_func_call = 35;	return_value_comedi_dio_config_2 = comedi_dio_config(it_g, 3, (i + 16), 0);
...
signed int elev_get_floor_sensor_signal() {
	signed int return_value_isTimerActive;
__iv__current_func_call = 36;	return_value_isTimerActive = isTimerActive();
	if ((return_value_isTimerActive == 0)) goto Node_4_258;
	if ((elev_motor == 0)) goto Node_4_257;
	signed int return_value_getTimerStatus;
__iv__current_func_call = 37;	return_value_getTimerStatus = getTimerStatus();
	if ((return_value_getTimerStatus == 0)) goto Node_4_248;
__iv__current_func_call = 38;	timerDeactivate();
...
__iv__current_func_call = 43;	return_value_io_read_bit = io_read_bit(button_channel_matrix[(signed long int)(floor)][(signed long int)(button)]);
...
__iv__current_func_call = 46;	timer = clock();
	...
	goto Node_7_316;
	Node_7_312:;
__iv__current_func_call = 47;	return_value_clock = clock();
...
signed int elev_get_stop_signal() {
	signed int return_value_io_read_bit;
__iv__current_func_call = 48;	return_value_io_read_bit = io_read_bit((0x300 + 22));
...
__iv__current_func_call = 49;	return_value_elev_get_button_signal = elev_get_button_signal((elev_button_type_t)(button), floorNum);
	if ((return_value_elev_get_button_signal == 0)) goto Node_10_451;
	orderMatrix[(signed long int)(button)][(signed long int)(floorNum)] = 1;
__iv__current_func_call = 50;	elev_set_button_lamp((elev_button_type_t)(button), floorNum, 1);
	Node_10_451:;
	floorNum = (floorNum + 1);
	goto Node_10_443;
	Node_10_456:;
...
signed int io_read_bit(signed int channel) {
	unsigned int data;
	data = 0u;
__iv__current_func_call = 51;	comedi_dio_read(it_g, (channel >> 8), (channel & 0xFF), (signed int*)(&data));
	return (signed int)(data);
}
void initStates() {
	signed int return_value_elev_get_floor_sensor_signal_0;
	signed int return_value_elev_get_floor_sensor_signal;
__iv__current_func_call = 52;	return_value_elev_get_floor_sensor_signal_0 = elev_get_floor_sensor_signal();
	if (!((return_value_elev_get_floor_sensor_signal_0 == -1))) goto Node_13_508;
__iv__current_func_call = 53;	elev_set_motor_direction((elev_motor_direction_t)(1));
	Node_13_502:;
__iv__current_func_call = 54;	return_value_elev_get_floor_sensor_signal = elev_get_floor_sensor_signal();
	if (!((return_value_elev_get_floor_sensor_signal == -1))) goto Node_13_507;
	if ((1 != 0)) goto Node_13_502;
	Node_13_507:;
	Node_13_508:;
__iv__current_func_call = 55;	elev_set_motor_direction((elev_motor_direction_t)(0));
	previousState = (elevState)(1);
...
signed int getTimerStatus() {
	...
	clock_t return_value_clock;
__iv__current_func_call = 56;	return_value_clock = clock();
...
signed int emergencyStopHandler() {
	...
	Node_16_558:;
	currentState = (elevState)(-1);
__iv__current_func_call = 57;	elev_set_motor_direction((elev_motor_direction_t)(0));
	goto Node_16_595;
	Node_16_561:;
	currentState = (elevState)(-1);
__iv__current_func_call = 58;	elev_set_motor_direction((elev_motor_direction_t)(0));
__iv__current_func_call = 59;	return_value_elev_get_floor_sensor_signal = elev_get_floor_sensor_signal();
	...
	goto Node_16_595;
	Node_16_571:;
__iv__current_func_call = 60;	flushOrders();
__iv__current_func_call = 61;	elev_set_motor_direction((elev_motor_direction_t)(0));
	Node_16_573:;
__iv__current_func_call = 62;	return_value_elev_get_stop_signal = elev_get_stop_signal();
	if ((return_value_elev_get_stop_signal == 0)) goto Node_16_578;
	if ((1 != 0)) goto Node_16_573;
	Node_16_578:;
__iv__current_func_call = 63;	return_value_elev_get_floor_sensor_signal_0 = elev_get_floor_sensor_signal();
...
__iv__current_func_call = 64;	return_value_io_init = io_init();
...
__iv__current_func_call = 65;	elev_set_button_lamp((elev_button_type_t)(1), i, 0);
	Node_17_624:;
	if ((i == 3)) goto Node_17_627;
__iv__current_func_call = 66;	elev_set_button_lamp((elev_button_type_t)(0), i, 0);
	Node_17_627:;
__iv__current_func_call = 67;	elev_set_button_lamp((elev_button_type_t)(2), i, 0);
	i = (i + 1);
	goto Node_17_621;
	Node_17_631:;
__iv__current_func_call = 68;	elev_set_floor_indicator(0);
	return 1;
}
signed int isTimerActive() {
	return timerActive;
...
__iv__current_func_call = 71;	elev_set_button_lamp((elev_button_type_t)(button), floorNum, 0);
	floorNum = (floorNum + 1);
	goto Node_21_674;
	Node_21_679:;
	button = (button + 1);
...
void startTimer(double length) {
__iv__current_func_call = 72;	timerStarted = clock();
	duration = length;
	timerActive = 1;
	// End of Function
}
...
void removeFromOrderMatrix(signed int floorNum) {
	...
	orderMatrix[(signed long int)(button)][(signed long int)(floorNum)] = 0;
__iv__current_func_call = 75;	elev_set_button_lamp((elev_button_type_t)(button), floorNum, 0);
	button = (button + 1);
	goto Node_30_712;
	Node_30_717:;
	// End of Function
...
__iv__current_func_call = 76;	io_read_bit((0x300 + 23));
	// End of Function
}
void elev_set_button_lamp(elev_button_type_t button, signed int floor, signed int value) {
	__CPROVER_assume((floor >= 0));
...
void elev_set_motor_direction(elev_motor_direction_t dirn) {
	...
	elev_motor = 1;
__iv__current_func_call = 83;	startTimer(3.0);
	goto Node_39_787;
	Node_39_783:;
	if (((signed int)(dirn) >= 0)) goto Node_39_786;
	elev_motor = -1;
__iv__current_func_call = 84;	startTimer(3.0);
	Node_39_786:;
	Node_39_787:;
	Node_39_788:;
	// End of Function
