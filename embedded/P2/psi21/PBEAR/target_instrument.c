...
__iv__current_func_call = 28;	return_value_elev_get_button_signal = elev_get_button_signal((elev_button_type_t)(button), floorNum);
	if ((return_value_elev_get_button_signal == 0)) goto Node_2_130;
	orderMatrix[(signed long int)(button)][(signed long int)(floorNum)] = 1;
__iv__current_func_call = 29;	elev_set_button_lamp((elev_button_type_t)(button), floorNum, 1);
	Node_2_130:;
	floorNum = (floorNum + 1);
	goto Node_2_122;
	Node_2_135:;
...
signed int io_init() {
	...
	signed int status;
	status = 0;
__iv__current_func_call = 30;	it_g = comedi_open("/dev/comedi0");
...
__iv__current_func_call = 31;	return_value_comedi_dio_config = comedi_dio_config(it_g, 2, i, 0);
	status = (status | return_value_comedi_dio_config);
	signed int return_value_comedi_dio_config_0;
__iv__current_func_call = 32;	return_value_comedi_dio_config_0 = comedi_dio_config(it_g, 3, i, 1);
	status = (status | return_value_comedi_dio_config_0);
	signed int return_value_comedi_dio_config_1;
__iv__current_func_call = 33;	return_value_comedi_dio_config_1 = comedi_dio_config(it_g, 3, (i + 8), 1);
	status = (status | return_value_comedi_dio_config_1);
	signed int return_value_comedi_dio_config_2;
__iv__current_func_call = 34;	return_value_comedi_dio_config_2 = comedi_dio_config(it_g, 3, (i + 16), 0);
...
void initStates() {
	...
	signed int return_value_elev_get_floor_sensor_signal;
__iv__current_func_call = 35;	return_value_elev_get_floor_sensor_signal_0 = elev_get_floor_sensor_signal();
	if (!((return_value_elev_get_floor_sensor_signal_0 == -1))) goto Node_4_208;
__iv__current_func_call = 36;	elev_set_motor_direction((elev_motor_direction_t)(1));
	Node_4_202:;
__iv__current_func_call = 37;	return_value_elev_get_floor_sensor_signal = elev_get_floor_sensor_signal();
	if (!((return_value_elev_get_floor_sensor_signal == -1))) goto Node_4_207;
	if ((1 != 0)) goto Node_4_202;
	Node_4_207:;
	Node_4_208:;
__iv__current_func_call = 38;	elev_set_motor_direction((elev_motor_direction_t)(0));
	previousState = (elevState)(1);
...
signed int elev_get_floor_sensor_signal() {
	signed int return_value_isTimerActive;
__iv__current_func_call = 39;	return_value_isTimerActive = isTimerActive();
	if ((return_value_isTimerActive == 0)) goto Node_5_247;
	if ((elev_motor == 0)) goto Node_5_246;
	signed int return_value_getTimerStatus;
__iv__current_func_call = 40;	return_value_getTimerStatus = getTimerStatus();
	if ((return_value_getTimerStatus == 0)) goto Node_5_237;
__iv__current_func_call = 41;	timerDeactivate();
...
__iv__current_func_call = 46;	return_value_io_read_bit = io_read_bit(button_channel_matrix[(signed long int)(floor)][(signed long int)(button)]);
...
__iv__current_func_call = 49;	timer = clock();
	...
	goto Node_8_304;
	Node_8_300:;
__iv__current_func_call = 50;	return_value_clock = clock();
...
signed int elev_get_stop_signal() {
	signed int return_value_io_read_bit;
__iv__current_func_call = 51;	return_value_io_read_bit = io_read_bit((0x300 + 22));
...
signed int io_read_bit(signed int channel) {
	unsigned int data;
	data = 0u;
__iv__current_func_call = 55;	comedi_dio_read(it_g, (channel >> 8), (channel & 0xFF), (signed int*)(&data));
...
signed int getTimerStatus() {
	...
	clock_t return_value_clock;
__iv__current_func_call = 58;	return_value_clock = clock();
	deltaTime = ((long double)((return_value_clock - timerStarted)) / 1.0l);
	if (!(((deltaTime >= (long double)(duration)) && !((timerActive == 0))))) goto Node_15_541;
	return 1;
	Node_15_541:;
	return 0;
}
...
signed int emergencyStopHandler() {
	...
	Node_17_570:;
	currentState = (elevState)(-1);
__iv__current_func_call = 59;	elev_set_motor_direction((elev_motor_direction_t)(0));
	goto Node_17_607;
	Node_17_573:;
	currentState = (elevState)(-1);
__iv__current_func_call = 60;	elev_set_motor_direction((elev_motor_direction_t)(0));
__iv__current_func_call = 61;	return_value_elev_get_floor_sensor_signal = elev_get_floor_sensor_signal();
	...
	goto Node_17_607;
	Node_17_583:;
__iv__current_func_call = 62;	flushOrders();
__iv__current_func_call = 63;	elev_set_motor_direction((elev_motor_direction_t)(0));
	Node_17_585:;
__iv__current_func_call = 64;	return_value_elev_get_stop_signal = elev_get_stop_signal();
	if ((return_value_elev_get_stop_signal == 0)) goto Node_17_590;
	if ((1 != 0)) goto Node_17_585;
	Node_17_590:;
__iv__current_func_call = 65;	return_value_elev_get_floor_sensor_signal_0 = elev_get_floor_sensor_signal();
...
__iv__current_func_call = 66;	return_value_io_init = io_init();
...
__iv__current_func_call = 67;	elev_set_button_lamp((elev_button_type_t)(1), i, 0);
	Node_18_636:;
	if ((i == 3)) goto Node_18_639;
__iv__current_func_call = 68;	elev_set_button_lamp((elev_button_type_t)(0), i, 0);
	Node_18_639:;
__iv__current_func_call = 69;	elev_set_button_lamp((elev_button_type_t)(2), i, 0);
	i = (i + 1);
	goto Node_18_633;
	Node_18_643:;
__iv__current_func_call = 70;	elev_set_floor_indicator(0);
	return 1;
}
signed int isTimerActive() {
	return timerActive;
