...
void check_property() {
	...
	(void)sizeof(signed int)  ;
	if (!(!((isAllReached != 0)))) __CPROVER_printf("violated property: Node_12_433");
...
signed int __iv__medianFilter_stub(){
	__CPROVER_printf("__iv__stub_call:medianFilter");
	...
	__CPROVER_printf("__iv__stub_output:__iv__return_expr_medianFilter=%d", __iv__return_expr_medianFilter);
