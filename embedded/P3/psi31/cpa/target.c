...
int reached0 = 0, reached1 = 0, reached2 = 0, reached3 = 0, reached4 = 0, reached5 = 0, reached6 = 0, reached7 = 0, reached8 = 0, reached9 = 0;
void update_prop_automata() {
	
	if (machineState == 0) reached0 = 1;
	if (machineState == 1) reached1 = 1;
	if (machineState == 2) reached2 = 1;
	if (machineState == 3) reached3 = 1;
	if (machineState == 4) reached4 = 1;
	if (machineState == 5) reached5 = 1;
	if (machineState == 6) reached6 = 1;
	if (machineState == 7) reached7 = 1;
	if (machineState == 8) reached8 = 1;
	if (machineState == 9) reached9 = 1;
	isAllReached = reached0 && reached1 && reached2 && reached3 && reached4 && reached5 && reached6 && reached7 && reached8 && reached9;
	// End of Function
}
void wait1Msec(signed int sec) {
	// End of Function
