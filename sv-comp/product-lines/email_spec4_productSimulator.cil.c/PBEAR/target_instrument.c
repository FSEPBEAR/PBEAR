...
void __utac_acc__SignForward_spec__1(signed int client, signed int msg) {
	...
	signed int tmp___0;
	puts("before mail\n");
__iv__current_func_call = 9;	tmp___0 = isSigned(msg);
	if (!((tmp___0 != 0))) goto Node_3_43;
__iv__current_func_call = 10;	tmp = getClientPrivateKey(client);
	if (!((tmp == 0))) goto Node_3_42;
__iv__current_func_call = 11;	__automaton_fail();
	Node_3_42:;
	Node_3_43:;
	goto Node_3_47;
	Node_3_47:;
...
void* __utac__error_stack_mgt(void* env, signed int mode, signed int count) {
	...
	*mem_19 = head;
	...
	free(__cil_tmp14);
__iv__current_func_call = 18;	__utac__exception__cf_handler_reset(excep);
	temp = next;
	count = (count - 1);
	goto Node_6_237;
	Node_6_254:;
	...
	free(__cil_tmp17);
__iv__current_func_call = 20;	__utac__exception__cf_handler_reset(excep);
	retValue_acc = excep;
	return retValue_acc;
	Node_6_289:;
...
void __utac__exception__cf_handler_reset(void* exception) {
	...
	Node_7_410:;
	Node_7_411:;
__iv__current_func_call = 22;	__utac__exception__cf_handler_free(exception);
	goto Node_7_431;
	Node_7_431:;
	// End of Function
}
...
signed int createEmail(signed int from, signed int to) {
	...
	signed int msg;
	msg = 1;
__iv__current_func_call = 25;	setEmailFrom(msg, from);
__iv__current_func_call = 26;	setEmailTo(msg, to);
	retValue_acc = msg;
	return retValue_acc;
}
void printMail__role__Verify(signed int msg) {
	signed int tmp;
	char *__cil_tmp3;
__iv__current_func_call = 27;	printMail__before__Verify(msg);
__iv__current_func_call = 28;	tmp = isVerified(msg);
...
void printMail__role__Sign(signed int msg) {
	...
	char *__cil_tmp4;
	char *__cil_tmp5;
__iv__current_func_call = 30;	printMail__before__Sign(msg);
__iv__current_func_call = 31;	tmp = isSigned(msg);
	__cil_tmp4 = (char*)("SIGNED\n  %i\n");
	printf(__cil_tmp4, tmp);
__iv__current_func_call = 33;	tmp___0 = getEmailSignKey(msg);
...
void printMail__before__Encrypt(signed int msg) {
	...
	char *__cil_tmp8;
	char *__cil_tmp9;
__iv__current_func_call = 35;	tmp = getEmailId(msg);
	__cil_tmp6 = (char*)("ID:\n  %i\n");
	printf(__cil_tmp6, tmp);
__iv__current_func_call = 37;	tmp___0 = getEmailFrom(msg);
	__cil_tmp7 = (char*)("FROM:\n  %i\n");
	printf(__cil_tmp7, tmp___0);
__iv__current_func_call = 39;	tmp___1 = getEmailTo(msg);
	__cil_tmp8 = (char*)("TO:\n  %i\n");
	printf(__cil_tmp8, tmp___1);
__iv__current_func_call = 41;	tmp___2 = isReadable(msg);
...
void bobKeyAdd() {
	...
	char *__cil_tmp3;
	char *__cil_tmp4;
__iv__current_func_call = 43;	createClientKeyringEntry(bob);
__iv__current_func_call = 44;	setClientKeyringUser(bob, 0, 2);
__iv__current_func_call = 45;	setClientKeyringPublicKey(bob, 0, 456);
	puts("bob added rjhs key");
__iv__current_func_call = 47;	tmp = getClientKeyringUser(bob, 0);
	__cil_tmp3 = (char*)("%d\n");
	printf(__cil_tmp3, tmp);
__iv__current_func_call = 49;	tmp___0 = getClientKeyringPublicKey(bob, 0);
	__cil_tmp4 = (char*)("%d\n");
...
void outgoing__role__Sign(signed int client, signed int msg) {
__iv__current_func_call = 51;	sign(client, msg);
__iv__current_func_call = 52;	outgoing__before__Sign(client, msg);
	goto Node_16_651;
	Node_16_651:;
	// End of Function
}
...
void outgoing__role__Encrypt(signed int client, signed int msg) {
	signed int receiver;
	signed int pubkey;
__iv__current_func_call = 53;	receiver = getEmailTo(msg);
__iv__current_func_call = 54;	pubkey = findPublicKey(client, receiver);
	if (!((pubkey != 0))) goto Node_19_716;
__iv__current_func_call = 55;	setEmailEncryptionKey(msg, pubkey);
__iv__current_func_call = 56;	setEmailIsEncrypted(msg, 1);
	Node_19_716:;
__iv__current_func_call = 57;	outgoing__before__Encrypt(client, msg);
	goto Node_19_723;
	Node_19_723:;
	// End of Function
}
void outgoing__before__Encrypt(signed int client, signed int msg) {
	signed int tmp;
__iv__current_func_call = 58;	tmp = getClientId(client);
__iv__current_func_call = 59;	setEmailFrom(msg, tmp);
__iv__current_func_call = 60;	mail(client, msg);
	goto Node_20_730;
	Node_20_730:;
	// End of Function
}
...
__iv__current_func_call = 62;	bobKeyAdd();
	Node_21_777:;
	op1 = 1;
	goto Node_21_781;
	Node_21_780:;
...
__iv__current_func_call = 64;	rjhSetAutoRespond();
	Node_21_788:;
	op2 = 1;
	goto Node_21_792;
	Node_21_791:;
...
__iv__current_func_call = 66;	rjhDeletePrivateKey();
	Node_21_799:;
	op3 = 1;
	goto Node_21_803;
	Node_21_802:;
...
__iv__current_func_call = 68;	rjhKeyAdd();
	Node_21_810:;
	op4 = 1;
	goto Node_21_814;
	Node_21_813:;
...
__iv__current_func_call = 70;	chuckKeyAddRjh();
	Node_21_821:;
	op5 = 1;
	goto Node_21_825;
	Node_21_824:;
...
__iv__current_func_call = 72;	rjhEnableForwarding();
	Node_21_832:;
	op6 = 1;
	goto Node_21_836;
	Node_21_835:;
...
__iv__current_func_call = 74;	rjhKeyChange();
	Node_21_843:;
	op7 = 1;
	goto Node_21_847;
	Node_21_846:;
...
__iv__current_func_call = 76;	bobSetAddressBook();
	Node_21_854:;
	op8 = 1;
	goto Node_21_858;
	Node_21_857:;
...
__iv__current_func_call = 78;	chuckKeyAdd();
	Node_21_865:;
	op9 = 1;
	goto Node_21_869;
	Node_21_868:;
...
__iv__current_func_call = 80;	bobKeyChange();
	Node_21_876:;
	op10 = 1;
	goto Node_21_880;
	Node_21_879:;
...
__iv__current_func_call = 82;	chuckKeyAdd();
	Node_21_887:;
	op11 = 1;
	goto Node_21_891;
	Node_21_890:;
	...
	Node_21_906:;
	Node_21_907:;
__iv__current_func_call = 83;	bobToRjh();
	goto Node_21_933;
	Node_21_933:;
	// End of Function
}
...
__iv__current_func_call = 84;	__utac_acc__SignForward_spec__1(__utac__ad__arg1, __utac__ad__arg2);
	puts("mail sent");
__iv__current_func_call = 86;	tmp = getEmailTo(msg);
__iv__current_func_call = 87;	incoming(tmp, msg);
	goto Node_22_947;
	Node_22_947:;
	// End of Function
}
...
__iv__current_func_call = 88;	printMail__role__Encrypt(msg);
	goto Node_23_955;
	Node_23_952:;
__iv__current_func_call = 89;	printMail__before__Encrypt(msg);
	goto Node_23_955;
	Node_23_955:;
	// End of Function
}
void generateKeyPair(signed int client, signed int seed) {
__iv__current_func_call = 90;	setClientPrivateKey(client, seed);
	goto Node_24_958;
	Node_24_958:;
	// End of Function
}
...
void sendEmail(signed int sender, signed int receiver) {
	signed int email;
__iv__current_func_call = 92;	email = createEmail(0, receiver);
__iv__current_func_call = 93;	outgoing(sender, email);
	goto Node_26_996;
	Node_26_996:;
	// End of Function
}
...
__iv__current_func_call = 95;	sender = getEmailFrom(msg);
__iv__current_func_call = 96;	setEmailTo(msg, sender);
__iv__current_func_call = 97;	queue(client, msg);
	goto Node_27_1007;
	Node_27_1007:;
	// End of Function
}
signed int createClient(char* name) {
	signed int retValue_acc;
	signed int client;
__iv__current_func_call = 98;	client = initClient();
	retValue_acc = client;
	return retValue_acc;
}
void incoming(signed int client, signed int msg) {
	if (!((__SELECTED_FEATURE_Decrypt != 0))) goto Node_29_1029;
__iv__current_func_call = 99;	incoming__role__Decrypt(client, msg);
	goto Node_29_1032;
	Node_29_1029:;
__iv__current_func_call = 100;	incoming__before__Decrypt(client, msg);
	goto Node_29_1032;
	Node_29_1032:;
	// End of Function
}
...
void printMail__role__Encrypt(signed int msg) {
	...
	char *__cil_tmp4;
	char *__cil_tmp5;
__iv__current_func_call = 101;	printMail__before__Encrypt(msg);
__iv__current_func_call = 102;	tmp = isEncrypted(msg);
	__cil_tmp4 = (char*)("ENCRYPTED\n  %d\n");
	printf(__cil_tmp4, tmp);
__iv__current_func_call = 104;	tmp___0 = getEmailEncryptionKey(msg);
...
void incoming__before__AutoResponder(signed int client, signed int msg) {
__iv__current_func_call = 107;	deliver(client, msg);
	goto Node_33_1078;
	Node_33_1078:;
	// End of Function
}
...
__iv__current_func_call = 108;	outgoing__role__AddressBook(client, msg);
	goto Node_42_1284;
	Node_42_1281:;
__iv__current_func_call = 109;	outgoing__before__AddressBook(client, msg);
	goto Node_42_1284;
	Node_42_1284:;
	// End of Function
}
...
signed int isReadable__role__Encrypt(signed int msg) {
	signed int retValue_acc;
	signed int tmp;
__iv__current_func_call = 111;	tmp = isEncrypted(msg);
	if (!((tmp != 0))) goto Node_51_1408;
	retValue_acc = 0;
	return retValue_acc;
	Node_51_1408:;
__iv__current_func_call = 112;	retValue_acc = isReadable__before__Encrypt(msg);
	return retValue_acc;
}
void queue(signed int client, signed int msg) {
	queue_empty = 0;
...
__iv__current_func_call = 113;	retValue_acc = isReadable__role__Encrypt(msg);
	return retValue_acc;
	Node_54_1460:;
__iv__current_func_call = 114;	retValue_acc = isReadable__before__Encrypt(msg);
	return retValue_acc;
}
void outgoing__before__AddressBook(signed int client, signed int msg) {
	if (!((__SELECTED_FEATURE_Encrypt != 0))) goto Node_55_1473;
__iv__current_func_call = 115;	outgoing__role__Encrypt(client, msg);
	goto Node_55_1476;
	Node_55_1473:;
__iv__current_func_call = 116;	outgoing__before__Encrypt(client, msg);
	goto Node_55_1476;
	Node_55_1476:;
	// End of Function
}
...
__iv__current_func_call = 117;	incoming__role__AutoResponder(client, msg);
	goto Node_56_1484;
	Node_56_1481:;
__iv__current_func_call = 118;	incoming__before__AutoResponder(client, msg);
	goto Node_56_1484;
	Node_56_1484:;
	// End of Function
}
...
__iv__current_func_call = 119;	printMail__role__Verify(msg);
	goto Node_57_1492;
	Node_57_1489:;
__iv__current_func_call = 120;	printMail__before__Verify(msg);
	goto Node_57_1492;
	Node_57_1492:;
	// End of Function
}
void incoming__role__Decrypt(signed int client, signed int msg) {
	...
	signed int tmp___1;
	signed int tmp___2;
__iv__current_func_call = 121;	privkey = getClientPrivateKey(client);
	if (!((privkey != 0))) goto Node_58_1510;
__iv__current_func_call = 122;	tmp___0 = isEncrypted(msg);
	if (!((tmp___0 != 0))) goto Node_58_1509;
__iv__current_func_call = 123;	tmp___1 = getEmailEncryptionKey(msg);
__iv__current_func_call = 124;	tmp___2 = isKeyPairValid(tmp___1, privkey);
	if (!((tmp___2 != 0))) goto Node_58_1508;
__iv__current_func_call = 125;	setEmailIsEncrypted(msg, 0);
__iv__current_func_call = 126;	setEmailEncryptionKey(msg, 0);
	Node_58_1508:;
	Node_58_1509:;
	Node_58_1510:;
__iv__current_func_call = 127;	incoming__before__Decrypt(client, msg);
	goto Node_58_1518;
	Node_58_1518:;
	// End of Function
}
...
void verify(signed int client, signed int msg) {
	...
	signed int tmp___3;
	signed int tmp___4;
__iv__current_func_call = 129;	tmp = isReadable(msg);
	if (!((tmp != 0))) goto Node_63_1681;
__iv__current_func_call = 130;	tmp___0 = isSigned(msg);
	...
	goto Node_63_1708;
	Node_63_1689:;
__iv__current_func_call = 131;	tmp___1 = getEmailFrom(msg);
__iv__current_func_call = 132;	pubkey = findPublicKey(client, tmp___1);
	if (!((pubkey != 0))) goto Node_63_1699;
__iv__current_func_call = 133;	tmp___3 = getEmailSignKey(msg);
__iv__current_func_call = 134;	tmp___4 = isKeyPairValid(tmp___3, pubkey);
	if (!((tmp___4 != 0))) goto Node_63_1698;
__iv__current_func_call = 135;	setEmailIsSignatureVerified(msg, 1);
	Node_63_1698:;
	Node_63_1699:;
	goto Node_63_1708;
	Node_63_1708:;
...
void outgoing__role__AddressBook(signed int client, signed int msg) {
	...
	signed int second;
	signed int tmp___2;
__iv__current_func_call = 136;	size = getClientAddressBookSize(client);
	if (!((size != 0))) goto Node_64_1732;
__iv__current_func_call = 137;	sendToAddressBook(client, msg);
	puts("sending to alias in address book\n");
__iv__current_func_call = 139;	receiver = getEmailTo(msg);
	puts("sending to second receipient\n");
__iv__current_func_call = 141;	second = getClientAddressBookAddress(client, 1);
__iv__current_func_call = 142;	setEmailTo(msg, second);
__iv__current_func_call = 143;	outgoing__before__AddressBook(client, msg);
__iv__current_func_call = 144;	tmp___2 = getClientAddressBookAddress(client, 0);
__iv__current_func_call = 145;	setEmailTo(msg, tmp___2);
__iv__current_func_call = 146;	outgoing__before__AddressBook(client, msg);
	goto Node_64_1733;
	Node_64_1732:;
__iv__current_func_call = 147;	outgoing__before__AddressBook(client, msg);
	Node_64_1733:;
	goto Node_64_1742;
	Node_64_1742:;
	// End of Function
...
__iv__current_func_call = 149;	sendEmail(bob, rjh);
__iv__current_func_call = 150;	tmp___1 = is_queue_empty();
	if ((tmp___1 != 0)) goto Node_66_1783;
__iv__current_func_call = 151;	tmp = get_queued_email();
__iv__current_func_call = 152;	tmp___0 = get_queued_client();
__iv__current_func_call = 153;	outgoing(tmp___0, tmp);
	Node_66_1783:;
	goto Node_66_1788;
	Node_66_1788:;
	// End of Function
...
void chuckKeyAdd() {
__iv__current_func_call = 154;	createClientKeyringEntry(chuck);
__iv__current_func_call = 155;	setClientKeyringUser(chuck, 0, 1);
__iv__current_func_call = 156;	setClientKeyringPublicKey(chuck, 0, 123);
	goto Node_68_1886;
	Node_68_1886:;
	// End of Function
}
...
__iv__current_func_call = 157;	setClientAutoResponse(rjh, 1);
	goto Node_74_2032;
	Node_74_2032:;
	// End of Function
}
void rjhToBob() {
	puts("Please enter a subject and a message body.\n");
__iv__current_func_call = 159;	sendEmail(rjh, bob);
	goto Node_75_2036;
	Node_75_2036:;
	// End of Function
}
...
__iv__current_func_call = 160;	setClientPrivateKey(rjh, 0);
	goto Node_78_2071;
	Node_78_2071:;
	// End of Function
}
...
__iv__current_func_call = 162;	printMail(msg);
__iv__current_func_call = 163;	queue(client, msg);
	goto Node_79_2076;
	Node_79_2076:;
	// End of Function
}
void rjhKeyAdd() {
__iv__current_func_call = 164;	createClientKeyringEntry(rjh);
__iv__current_func_call = 165;	setClientKeyringUser(rjh, 0, 1);
__iv__current_func_call = 166;	setClientKeyringPublicKey(rjh, 0, 123);
	goto Node_80_2081;
	Node_80_2081:;
	// End of Function
}
void setup() {
	...
	char *__cil_tmp3;
	bob = 1;
__iv__current_func_call = 167;	setup_bob(bob);
	__cil_tmp1 = (char*)("bob: %d\n");
	printf(__cil_tmp1, bob);
	rjh = 2;
__iv__current_func_call = 169;	setup_rjh(rjh);
	__cil_tmp2 = (char*)("rjh: %d\n");
	printf(__cil_tmp2, rjh);
	chuck = 3;
__iv__current_func_call = 171;	setup_chuck(chuck);
...
void chuckKeyAddRjh() {
__iv__current_func_call = 173;	createClientKeyringEntry(chuck);
__iv__current_func_call = 174;	setClientKeyringUser(chuck, 0, 2);
__iv__current_func_call = 175;	setClientKeyringPublicKey(chuck, 0, 456);
	goto Node_83_2136;
	Node_83_2136:;
	// End of Function
}
...
__iv__current_func_call = 176;	printMail__role__Sign(msg);
	goto Node_84_2144;
	Node_84_2141:;
__iv__current_func_call = 177;	printMail__before__Sign(msg);
	goto Node_84_2144;
	Node_84_2144:;
	// End of Function
}
void rjhEnableForwarding() {
__iv__current_func_call = 178;	setClientForwardReceiver(rjh, chuck);
	goto Node_85_2147;
	Node_85_2147:;
	// End of Function
}
void rjhKeyChange() {
__iv__current_func_call = 179;	generateKeyPair(rjh, 666);
	goto Node_86_2150;
	Node_86_2150:;
	// End of Function
}
void bobSetAddressBook() {
__iv__current_func_call = 180;	setClientAddressBookSize(bob, 1);
__iv__current_func_call = 181;	setClientAddressBookAlias(bob, 0, rjh);
__iv__current_func_call = 182;	setClientAddressBookAddress(bob, 0, rjh);
__iv__current_func_call = 183;	setClientAddressBookAddress(bob, 1, chuck);
	goto Node_87_2156;
	Node_87_2156:;
	// End of Function
}
void bobKeyChange() {
__iv__current_func_call = 184;	generateKeyPair(bob, 777);
	goto Node_88_2159;
	Node_88_2159:;
	// End of Function
}
...
__iv__current_func_call = 185;	reach_error();
	abort();
}
void setClientPrivateKey(signed int handle, signed int value) {
...
__iv__current_func_call = 187;	incoming__before__Forward(client, msg);
__iv__current_func_call = 188;	fwreceiver = getClientForwardReceiver(client);
	if (!((fwreceiver != 0))) goto Node_92_2198;
__iv__current_func_call = 189;	setEmailTo(msg, fwreceiver);
__iv__current_func_call = 190;	forward(client, msg);
	Node_92_2198:;
	goto Node_92_2202;
	Node_92_2202:;
	// End of Function
...
__iv__current_func_call = 191;	size = getClientKeyringSize(handle);
	if (!((size < 2))) goto Node_94_2229;
	__cil_tmp5 = (size + 1);
__iv__current_func_call = 192;	setClientKeyringSize(handle, __cil_tmp5);
	retValue_acc = (size + 1);
	return retValue_acc;
	Node_94_2229:;
	retValue_acc = -1;
...
__iv__current_func_call = 193;	incoming__role__Verify(client, msg);
	goto Node_95_2251;
	Node_95_2248:;
__iv__current_func_call = 194;	incoming__before__Verify(client, msg);
	goto Node_95_2251;
	Node_95_2251:;
	// End of Function
}
...
signed int createClientAddressBookEntry(signed int handle) {
	...
	signed int size;
	signed int __cil_tmp5;
__iv__current_func_call = 195;	size = getClientAddressBookSize(handle);
	if (!((size < 3))) goto Node_99_2332;
	__cil_tmp5 = (size + 1);
__iv__current_func_call = 196;	setClientAddressBookSize(handle, __cil_tmp5);
	retValue_acc = (size + 1);
	return retValue_acc;
	Node_99_2332:;
	retValue_acc = -1;
...
void setup_bob__before__Keys(signed int bob___0) {
__iv__current_func_call = 198;	setClientId(bob___0, bob___0);
	goto Node_110_2789;
	Node_110_2789:;
	// End of Function
}
void setup_rjh__role__Keys(signed int rjh___0) {
__iv__current_func_call = 199;	setup_rjh__before__Keys(rjh___0);
__iv__current_func_call = 200;	setClientPrivateKey(rjh___0, 456);
	goto Node_111_2793;
	Node_111_2793:;
	// End of Function
}
...
void incoming__role__AutoResponder(signed int client, signed int msg) {
	signed int tmp;
__iv__current_func_call = 201;	incoming__before__AutoResponder(client, msg);
__iv__current_func_call = 202;	tmp = getClientAutoResponse(client);
	if (!((tmp != 0))) goto Node_116_2930;
__iv__current_func_call = 203;	autoRespond(client, msg);
	Node_116_2930:;
	goto Node_116_2933;
	Node_116_2933:;
	// End of Function
...
void incoming__role__Verify(signed int client, signed int msg) {
__iv__current_func_call = 204;	verify(client, msg);
__iv__current_func_call = 205;	incoming__before__Verify(client, msg);
	goto Node_118_2946;
	Node_118_2946:;
	// End of Function
}
...
__iv__current_func_call = 206;	incoming__role__Forward(client, msg);
	goto Node_119_2954;
	Node_119_2951:;
__iv__current_func_call = 207;	incoming__before__Forward(client, msg);
	goto Node_119_2954;
	Node_119_2954:;
	// End of Function
}
...
__iv__current_func_call = 208;	__SELECTED_FEATURE_Base = select_one();
__iv__current_func_call = 209;	__SELECTED_FEATURE_Keys = select_one();
__iv__current_func_call = 210;	__SELECTED_FEATURE_Encrypt = select_one();
__iv__current_func_call = 211;	__SELECTED_FEATURE_AutoResponder = select_one();
__iv__current_func_call = 212;	__SELECTED_FEATURE_AddressBook = select_one();
	__SELECTED_FEATURE_Sign = 1;
__iv__current_func_call = 213;	__SELECTED_FEATURE_Forward = select_one();
__iv__current_func_call = 214;	__SELECTED_FEATURE_Verify = select_one();
__iv__current_func_call = 215;	__SELECTED_FEATURE_Decrypt = select_one();
	goto Node_121_2996;
	Node_121_2996:;
	// End of Function
}
...
__iv__current_func_call = 216;	setup_rjh__role__Keys(rjh___0);
	goto Node_122_3004;
	Node_122_3001:;
__iv__current_func_call = 217;	setup_rjh__before__Keys(rjh___0);
	goto Node_122_3004;
	Node_122_3004:;
	// End of Function
}
...
__iv__current_func_call = 220;	outgoing__role__Sign(client, msg);
	goto Node_127_3049;
	Node_127_3046:;
__iv__current_func_call = 221;	outgoing__before__Sign(client, msg);
	goto Node_127_3049;
	Node_127_3049:;
	// End of Function
}
...
__iv__current_func_call = 222;	setup_bob__role__Keys(bob___0);
	goto Node_128_3057;
	Node_128_3054:;
__iv__current_func_call = 223;	setup_bob__before__Keys(bob___0);
	goto Node_128_3057;
	Node_128_3057:;
	// End of Function
}
void bobKeyAddChuck() {
__iv__current_func_call = 224;	createClientKeyringEntry(bob);
__iv__current_func_call = 225;	setClientKeyringUser(bob, 1, 3);
__iv__current_func_call = 226;	setClientKeyringPublicKey(bob, 1, 789);
	goto Node_129_3062;
	Node_129_3062:;
	// End of Function
}
void rjhKeyAddChuck() {
__iv__current_func_call = 227;	createClientKeyringEntry(rjh);
__iv__current_func_call = 228;	setClientKeyringUser(rjh, 0, 3);
__iv__current_func_call = 229;	setClientKeyringPublicKey(rjh, 0, 789);
	goto Node_130_3067;
	Node_130_3067:;
	// End of Function
}
void setup_bob__role__Keys(signed int bob___0) {
__iv__current_func_call = 230;	setup_bob__before__Keys(bob___0);
__iv__current_func_call = 231;	setClientPrivateKey(bob___0, 123);
	goto Node_131_3071;
	Node_131_3071:;
	// End of Function
}
void setup_rjh__before__Keys(signed int rjh___0) {
__iv__current_func_call = 232;	setClientId(rjh___0, rjh___0);
	goto Node_132_3074;
	Node_132_3074:;
	// End of Function
}
void setup_chuck__before__Keys(signed int chuck___0) {
__iv__current_func_call = 233;	setClientId(chuck___0, chuck___0);
	goto Node_133_3077;
	Node_133_3077:;
	// End of Function
}
void setup_chuck__role__Keys(signed int chuck___0) {
__iv__current_func_call = 234;	setup_chuck__before__Keys(chuck___0);
__iv__current_func_call = 235;	setClientPrivateKey(chuck___0, 789);
	goto Node_134_3081;
	Node_134_3081:;
	// End of Function
}
