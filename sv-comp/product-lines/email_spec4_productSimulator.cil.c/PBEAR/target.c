...
char* __utac__get_this_argtype(signed int i, struct JoinPoint* this) {
	...
	signed int *mem_12;
	char ***mem_13;
	if (!((i > 0))) __CPROVER_printf("violated property: Node_4_59");
	assert((i > 0));
	...
	__cil_tmp6 = *mem_12;
	if (!((i <= __cil_tmp6))) __CPROVER_printf("violated property: Node_4_65");
	assert((i <= __cil_tmp6));
	Node_4_66:;
	__cil_tmp7 = (i - 1);
...
void* __utac__get_this_arg(signed int i, struct JoinPoint* this) {
	...
	signed int *mem_12;
	void ***mem_13;
	if (!((i > 0))) __CPROVER_printf("violated property: Node_5_112");
	assert((i > 0));
	...
	mem_12 = (signed int*)(__cil_tmp5);
	__cil_tmp6 = *mem_12;
	if (!((i <= __cil_tmp6))) __CPROVER_printf("violated property: Node_5_118");
	assert((i <= __cil_tmp6));
	Node_5_119:;
	__cil_tmp7 = (i - 1);
	__cil_tmp8 = (unsigned long int)(this);
...
void reach_error() {
	if (!(FALSE)) __CPROVER_printf("violated property: Node_48_1378");
	assert(FALSE);
	// End of Function
}
