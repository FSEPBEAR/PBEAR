...
void* __utac__error_stack_mgt(void* env, signed int mode, signed int count) {
	...
	*mem_19 = head;
	...
	free(__cil_tmp14);
__iv__current_func_call = 15;	__utac__exception__cf_handler_reset(excep);
	temp = next;
	count = (count - 1);
	goto Node_6_240;
	Node_6_257:;
	...
	free(__cil_tmp17);
__iv__current_func_call = 17;	__utac__exception__cf_handler_reset(excep);
	retValue_acc = excep;
	return retValue_acc;
	Node_6_292:;
...
void __utac__exception__cf_handler_reset(void* exception) {
	...
	Node_7_413:;
	Node_7_414:;
__iv__current_func_call = 19;	__utac__exception__cf_handler_free(exception);
	goto Node_7_434;
	Node_7_434:;
	// End of Function
}
...
__iv__current_func_call = 23;	bobKeyAdd();
	Node_11_661:;
	op1 = 1;
	goto Node_11_665;
	Node_11_664:;
...
__iv__current_func_call = 25;	rjhSetAutoRespond();
	Node_11_672:;
	op2 = 1;
	goto Node_11_676;
	Node_11_675:;
...
__iv__current_func_call = 27;	rjhDeletePrivateKey();
	Node_11_683:;
	op3 = 1;
	goto Node_11_687;
	Node_11_686:;
...
__iv__current_func_call = 29;	rjhKeyAdd();
	Node_11_694:;
	op4 = 1;
	goto Node_11_698;
	Node_11_697:;
...
__iv__current_func_call = 31;	chuckKeyAddRjh();
	Node_11_705:;
	op5 = 1;
	goto Node_11_709;
	Node_11_708:;
...
__iv__current_func_call = 33;	rjhEnableForwarding();
	Node_11_716:;
	op6 = 1;
	goto Node_11_720;
	Node_11_719:;
...
__iv__current_func_call = 35;	rjhKeyChange();
	Node_11_727:;
	op7 = 1;
	goto Node_11_731;
	Node_11_730:;
...
__iv__current_func_call = 37;	bobSetAddressBook();
	Node_11_738:;
	op8 = 1;
	goto Node_11_742;
	Node_11_741:;
...
__iv__current_func_call = 39;	chuckKeyAdd();
	Node_11_749:;
	op9 = 1;
	goto Node_11_753;
	Node_11_752:;
...
__iv__current_func_call = 41;	bobKeyChange();
	Node_11_760:;
	op10 = 1;
	goto Node_11_764;
	Node_11_763:;
...
__iv__current_func_call = 43;	chuckKeyAdd();
	Node_11_771:;
	op11 = 1;
	goto Node_11_775;
	Node_11_774:;
	...
	Node_11_790:;
	Node_11_791:;
__iv__current_func_call = 44;	bobToRjh();
	goto Node_11_817;
	Node_11_817:;
	// End of Function
}
...
__iv__current_func_call = 45;	__utac_acc__EncryptVerify_spec__1(__utac__ad__arg1);
__iv__current_func_call = 46;	tmp = isReadable(msg);
	if (!((tmp != 0))) goto Node_15_975;
__iv__current_func_call = 47;	tmp___0 = isSigned(msg);
	...
	goto Node_15_1004;
	Node_15_984:;
__iv__current_func_call = 48;	tmp___1 = getEmailFrom(msg);
__iv__current_func_call = 49;	pubkey = findPublicKey(client, tmp___1);
	if (!((pubkey != 0))) goto Node_15_994;
__iv__current_func_call = 50;	tmp___3 = getEmailSignKey(msg);
__iv__current_func_call = 51;	tmp___4 = isKeyPairValid(tmp___3, pubkey);
	if (!((tmp___4 != 0))) goto Node_15_993;
__iv__current_func_call = 52;	setEmailIsSignatureVerified(msg, 1);
	Node_15_993:;
	Node_15_994:;
	goto Node_15_1004;
	Node_15_1004:;
...
void printMail__role__Verify(signed int msg) {
	signed int tmp;
	char *__cil_tmp3;
__iv__current_func_call = 53;	printMail__before__Verify(msg);
__iv__current_func_call = 54;	tmp = isVerified(msg);
...
void printMail__role__Sign(signed int msg) {
	...
	char *__cil_tmp4;
	char *__cil_tmp5;
__iv__current_func_call = 56;	printMail__before__Sign(msg);
__iv__current_func_call = 57;	tmp = isSigned(msg);
	__cil_tmp4 = (char*)("SIGNED\n  %i\n");
	printf(__cil_tmp4, tmp);
__iv__current_func_call = 59;	tmp___0 = getEmailSignKey(msg);
...
__iv__current_func_call = 62;	sender = getEmailFrom(msg);
__iv__current_func_call = 63;	setEmailTo(msg, sender);
__iv__current_func_call = 64;	queue(client, msg);
	goto Node_18_1042;
	Node_18_1042:;
	// End of Function
}
...
void incoming__role__Decrypt(signed int client, signed int msg) {
	...
	signed int tmp___1;
	signed int tmp___2;
__iv__current_func_call = 65;	privkey = getClientPrivateKey(client);
	if (!((privkey != 0))) goto Node_22_1101;
__iv__current_func_call = 66;	tmp___0 = isEncrypted(msg);
	if (!((tmp___0 != 0))) goto Node_22_1100;
__iv__current_func_call = 67;	tmp___1 = getEmailEncryptionKey(msg);
__iv__current_func_call = 68;	tmp___2 = isKeyPairValid(tmp___1, privkey);
	if (!((tmp___2 != 0))) goto Node_22_1099;
__iv__current_func_call = 69;	setEmailIsEncrypted(msg, 0);
__iv__current_func_call = 70;	setEmailEncryptionKey(msg, 0);
	Node_22_1099:;
	Node_22_1100:;
	Node_22_1101:;
__iv__current_func_call = 71;	incoming__before__Decrypt(client, msg);
	goto Node_22_1109;
	Node_22_1109:;
	// End of Function
}
...
__iv__current_func_call = 72;	size = getClientAddressBookSize(handle);
	if (!((size < 3))) goto Node_23_1127;
	__cil_tmp5 = (size + 1);
__iv__current_func_call = 73;	setClientAddressBookSize(handle, __cil_tmp5);
	retValue_acc = (size + 1);
	return retValue_acc;
	Node_23_1127:;
	retValue_acc = -1;
...
__iv__current_func_call = 74;	incoming__role__Forward(client, msg);
	goto Node_25_1162;
	Node_25_1159:;
__iv__current_func_call = 75;	incoming__before__Forward(client, msg);
	goto Node_25_1162;
	Node_25_1162:;
	// End of Function
}
...
void incoming__before__AutoResponder(signed int client, signed int msg) {
__iv__current_func_call = 77;	deliver(client, msg);
	goto Node_28_1315;
	Node_28_1315:;
	// End of Function
}
void outgoing__role__AddressBook(signed int client, signed int msg) {
	...
	signed int second;
	signed int tmp___2;
__iv__current_func_call = 78;	size = getClientAddressBookSize(client);
	if (!((size != 0))) goto Node_29_1339;
__iv__current_func_call = 79;	sendToAddressBook(client, msg);
	puts("sending to alias in address book\n");
__iv__current_func_call = 81;	receiver = getEmailTo(msg);
	puts("sending to second receipient\n");
__iv__current_func_call = 83;	second = getClientAddressBookAddress(client, 1);
__iv__current_func_call = 84;	setEmailTo(msg, second);
__iv__current_func_call = 85;	outgoing__before__AddressBook(client, msg);
__iv__current_func_call = 86;	tmp___2 = getClientAddressBookAddress(client, 0);
__iv__current_func_call = 87;	setEmailTo(msg, tmp___2);
__iv__current_func_call = 88;	outgoing__before__AddressBook(client, msg);
	goto Node_29_1340;
	Node_29_1339:;
...
__iv__current_func_call = 90;	outgoing__role__Encrypt(client, msg);
	goto Node_31_1380;
	Node_31_1377:;
__iv__current_func_call = 91;	outgoing__before__Encrypt(client, msg);
	goto Node_31_1380;
	Node_31_1380:;
	// End of Function
}
void mail(signed int client, signed int msg) {
	signed int tmp;
	puts("mail sent");
__iv__current_func_call = 93;	tmp = getEmailTo(msg);
__iv__current_func_call = 94;	incoming(tmp, msg);
	goto Node_32_1387;
	Node_32_1387:;
	// End of Function
}
void __utac_acc__EncryptVerify_spec__1(signed int msg) {
	signed int tmp;
__iv__current_func_call = 95;	tmp = isReadable(msg);
	if ((tmp != 0)) goto Node_33_1392;
__iv__current_func_call = 96;	__automaton_fail();
	Node_33_1392:;
	goto Node_33_1395;
	Node_33_1395:;
	// End of Function
...
__iv__current_func_call = 97;	incoming__before__Forward(client, msg);
__iv__current_func_call = 98;	fwreceiver = getClientForwardReceiver(client);
	if (!((fwreceiver != 0))) goto Node_34_1404;
__iv__current_func_call = 99;	setEmailTo(msg, fwreceiver);
__iv__current_func_call = 100;	forward(client, msg);
	Node_34_1404:;
	goto Node_34_1408;
	Node_34_1408:;
	// End of Function
...
void setup() {
	...
	char *__cil_tmp3;
	bob = 1;
__iv__current_func_call = 101;	setup_bob(bob);
	__cil_tmp1 = (char*)("bob: %d\n");
	printf(__cil_tmp1, bob);
	rjh = 2;
__iv__current_func_call = 103;	setup_rjh(rjh);
	__cil_tmp2 = (char*)("rjh: %d\n");
	printf(__cil_tmp2, rjh);
	chuck = 3;
__iv__current_func_call = 105;	setup_chuck(chuck);
...
__iv__current_func_call = 107;	printMail__role__Sign(msg);
	goto Node_36_1436;
	Node_36_1433:;
__iv__current_func_call = 108;	printMail__before__Sign(msg);
	goto Node_36_1436;
	Node_36_1436:;
	// End of Function
}
...
__iv__current_func_call = 110;	sendEmail(rjh, bob);
	goto Node_37_1440;
	Node_37_1440:;
	// End of Function
}
...
void incoming__role__AutoResponder(signed int client, signed int msg) {
	signed int tmp;
__iv__current_func_call = 112;	incoming__before__AutoResponder(client, msg);
__iv__current_func_call = 113;	tmp = getClientAutoResponse(client);
	if (!((tmp != 0))) goto Node_43_1512;
__iv__current_func_call = 114;	autoRespond(client, msg);
	Node_43_1512:;
	goto Node_43_1515;
	Node_43_1515:;
	// End of Function
...
__iv__current_func_call = 115;	printMail__role__Encrypt(msg);
	goto Node_45_1595;
	Node_45_1592:;
__iv__current_func_call = 116;	printMail__before__Encrypt(msg);
	goto Node_45_1595;
	Node_45_1595:;
	// End of Function
}
...
__iv__current_func_call = 117;	outgoing__role__Sign(client, msg);
	goto Node_46_1603;
	Node_46_1600:;
__iv__current_func_call = 118;	outgoing__before__Sign(client, msg);
	goto Node_46_1603;
	Node_46_1603:;
	// End of Function
}
...
void printMail__role__Encrypt(signed int msg) {
	...
	char *__cil_tmp4;
	char *__cil_tmp5;
__iv__current_func_call = 119;	printMail__before__Encrypt(msg);
__iv__current_func_call = 120;	tmp = isEncrypted(msg);
	__cil_tmp4 = (char*)("ENCRYPTED\n  %d\n");
	printf(__cil_tmp4, tmp);
__iv__current_func_call = 122;	tmp___0 = getEmailEncryptionKey(msg);
...
void outgoing__role__Encrypt(signed int client, signed int msg) {
	signed int receiver;
	signed int pubkey;
__iv__current_func_call = 125;	receiver = getEmailTo(msg);
__iv__current_func_call = 126;	pubkey = findPublicKey(client, receiver);
	if (!((pubkey != 0))) goto Node_51_1662;
__iv__current_func_call = 127;	setEmailEncryptionKey(msg, pubkey);
__iv__current_func_call = 128;	setEmailIsEncrypted(msg, 1);
	Node_51_1662:;
__iv__current_func_call = 129;	outgoing__before__Encrypt(client, msg);
	goto Node_51_1669;
	Node_51_1669:;
	// End of Function
}
void outgoing__before__Encrypt(signed int client, signed int msg) {
	signed int tmp;
__iv__current_func_call = 130;	tmp = getClientId(client);
__iv__current_func_call = 131;	setEmailFrom(msg, tmp);
__iv__current_func_call = 132;	mail(client, msg);
	goto Node_52_1676;
	Node_52_1676:;
	// End of Function
}
void bobSetAddressBook() {
__iv__current_func_call = 133;	setClientAddressBookSize(bob, 1);
__iv__current_func_call = 134;	setClientAddressBookAlias(bob, 0, rjh);
__iv__current_func_call = 135;	setClientAddressBookAddress(bob, 0, rjh);
__iv__current_func_call = 136;	setClientAddressBookAddress(bob, 1, chuck);
	goto Node_53_1682;
	Node_53_1682:;
	// End of Function
}
...
__iv__current_func_call = 138;	printMail(msg);
__iv__current_func_call = 139;	queue(client, msg);
	goto Node_56_1705;
	Node_56_1705:;
	// End of Function
}
void bobToRjh() {
	...
	signed int tmp___1;
	puts("Please enter a subject and a message body.\n");
__iv__current_func_call = 141;	sendEmail(bob, rjh);
__iv__current_func_call = 142;	tmp___1 = is_queue_empty();
	if ((tmp___1 != 0)) goto Node_57_1716;
__iv__current_func_call = 143;	tmp = get_queued_email();
__iv__current_func_call = 144;	tmp___0 = get_queued_client();
__iv__current_func_call = 145;	outgoing(tmp___0, tmp);
	Node_57_1716:;
	goto Node_57_1721;
	Node_57_1721:;
	// End of Function
...
__iv__current_func_call = 146;	incoming__role__AutoResponder(client, msg);
	goto Node_60_1831;
	Node_60_1828:;
__iv__current_func_call = 147;	incoming__before__AutoResponder(client, msg);
	goto Node_60_1831;
	Node_60_1831:;
	// End of Function
}
...
__iv__current_func_call = 148;	setup_chuck__role__Keys(chuck___0);
	goto Node_62_1868;
	Node_62_1865:;
__iv__current_func_call = 149;	setup_chuck__before__Keys(chuck___0);
	goto Node_62_1868;
	Node_62_1868:;
	// End of Function
}
void rjhDeletePrivateKey() {
__iv__current_func_call = 150;	setClientPrivateKey(rjh, 0);
	goto Node_63_1871;
	Node_63_1871:;
	// End of Function
}
...
void rjhKeyChange() {
__iv__current_func_call = 151;	generateKeyPair(rjh, 666);
	goto Node_65_1897;
	Node_65_1897:;
	// End of Function
}
...
void incoming__role__Verify(signed int client, signed int msg) {
__iv__current_func_call = 152;	verify(client, msg);
__iv__current_func_call = 153;	incoming__before__Verify(client, msg);
	goto Node_68_1940;
	Node_68_1940:;
	// End of Function
}
...
__iv__current_func_call = 157;	printMail__role__Verify(msg);
	goto Node_71_1976;
	Node_71_1973:;
__iv__current_func_call = 158;	printMail__before__Verify(msg);
	goto Node_71_1976;
	Node_71_1976:;
	// End of Function
}
...
__iv__current_func_call = 159;	outgoing__role__AddressBook(client, msg);
	goto Node_72_1984;
	Node_72_1981:;
__iv__current_func_call = 160;	outgoing__before__AddressBook(client, msg);
	goto Node_72_1984;
	Node_72_1984:;
	// End of Function
}
...
signed int createEmail(signed int from, signed int to) {
	...
	signed int msg;
	msg = 1;
__iv__current_func_call = 161;	setEmailFrom(msg, from);
__iv__current_func_call = 162;	setEmailTo(msg, to);
	retValue_acc = msg;
	return retValue_acc;
}
void setClientAddressBookAddress(signed int handle, signed int index, signed int value) {
...
void bobKeyChange() {
__iv__current_func_call = 163;	generateKeyPair(bob, 777);
	goto Node_77_2084;
	Node_77_2084:;
	// End of Function
}
signed int createClientKeyringEntry(signed int handle) {
	...
	signed int size;
	signed int __cil_tmp5;
__iv__current_func_call = 164;	size = getClientKeyringSize(handle);
	if (!((size < 2))) goto Node_78_2102;
	__cil_tmp5 = (size + 1);
__iv__current_func_call = 165;	setClientKeyringSize(handle, __cil_tmp5);
	retValue_acc = (size + 1);
	return retValue_acc;
	Node_78_2102:;
	retValue_acc = -1;
...
__iv__current_func_call = 166;	incoming__role__Verify(client, msg);
	goto Node_81_2146;
	Node_81_2143:;
__iv__current_func_call = 167;	incoming__before__Verify(client, msg);
	goto Node_81_2146;
	Node_81_2146:;
	// End of Function
}
void outgoing__role__Sign(signed int client, signed int msg) {
__iv__current_func_call = 168;	sign(client, msg);
__iv__current_func_call = 169;	outgoing__before__Sign(client, msg);
	goto Node_82_2150;
	Node_82_2150:;
	// End of Function
}
void bobKeyAdd() {
	...
	char *__cil_tmp3;
	char *__cil_tmp4;
__iv__current_func_call = 170;	createClientKeyringEntry(bob);
__iv__current_func_call = 171;	setClientKeyringUser(bob, 0, 2);
__iv__current_func_call = 172;	setClientKeyringPublicKey(bob, 0, 456);
	puts("bob added rjhs key");
__iv__current_func_call = 174;	tmp = getClientKeyringUser(bob, 0);
	__cil_tmp3 = (char*)("%d\n");
	printf(__cil_tmp3, tmp);
__iv__current_func_call = 176;	tmp___0 = getClientKeyringPublicKey(bob, 0);
	__cil_tmp4 = (char*)("%d\n");
...
void setup_chuck__before__Keys(signed int chuck___0) {
__iv__current_func_call = 178;	setClientId(chuck___0, chuck___0);
	goto Node_84_2173;
	Node_84_2173:;
	// End of Function
}
...
signed int createClient(char* name) {
	signed int retValue_acc;
	signed int client;
__iv__current_func_call = 179;	client = initClient();
	retValue_acc = client;
	return retValue_acc;
}
void __automaton_fail() {
__iv__current_func_call = 180;	reach_error();
	abort();
}
signed int getClientAutoResponse(signed int handle) {
	signed int retValue_acc;
...
void printMail__before__Encrypt(signed int msg) {
	...
	char *__cil_tmp8;
	char *__cil_tmp9;
__iv__current_func_call = 182;	tmp = getEmailId(msg);
	__cil_tmp6 = (char*)("ID:\n  %i\n");
	printf(__cil_tmp6, tmp);
__iv__current_func_call = 184;	tmp___0 = getEmailFrom(msg);
	__cil_tmp7 = (char*)("FROM:\n  %i\n");
	printf(__cil_tmp7, tmp___0);
__iv__current_func_call = 186;	tmp___1 = getEmailTo(msg);
	__cil_tmp8 = (char*)("TO:\n  %i\n");
	printf(__cil_tmp8, tmp___1);
__iv__current_func_call = 188;	tmp___2 = isReadable(msg);
...
void setup_chuck__role__Keys(signed int chuck___0) {
__iv__current_func_call = 190;	setup_chuck__before__Keys(chuck___0);
__iv__current_func_call = 191;	setClientPrivateKey(chuck___0, 789);
	goto Node_95_2449;
	Node_95_2449:;
	// End of Function
}
...
void sendEmail(signed int sender, signed int receiver) {
	signed int email;
__iv__current_func_call = 192;	email = createEmail(0, receiver);
__iv__current_func_call = 193;	outgoing(sender, email);
	goto Node_99_2499;
	Node_99_2499:;
	// End of Function
}
...
__iv__current_func_call = 194;	retValue_acc = isReadable__role__Encrypt(msg);
	return retValue_acc;
	Node_101_2516:;
__iv__current_func_call = 195;	retValue_acc = isReadable__before__Encrypt(msg);
	return retValue_acc;
}
...
void setup_rjh__before__Keys(signed int rjh___0) {
__iv__current_func_call = 196;	setClientId(rjh___0, rjh___0);
	goto Node_105_2562;
	Node_105_2562:;
	// End of Function
}
...
__iv__current_func_call = 198;	incoming__role__Decrypt(client, msg);
	goto Node_113_2854;
	Node_113_2851:;
__iv__current_func_call = 199;	incoming__before__Decrypt(client, msg);
	goto Node_113_2854;
	Node_113_2854:;
	// End of Function
}
...
__iv__current_func_call = 200;	__SELECTED_FEATURE_Base = select_one();
__iv__current_func_call = 201;	__SELECTED_FEATURE_Keys = select_one();
__iv__current_func_call = 202;	__SELECTED_FEATURE_Encrypt = select_one();
__iv__current_func_call = 203;	__SELECTED_FEATURE_AutoResponder = select_one();
__iv__current_func_call = 204;	__SELECTED_FEATURE_AddressBook = select_one();
__iv__current_func_call = 205;	__SELECTED_FEATURE_Sign = select_one();
__iv__current_func_call = 206;	__SELECTED_FEATURE_Forward = select_one();
	__SELECTED_FEATURE_Verify = 1;
__iv__current_func_call = 207;	__SELECTED_FEATURE_Decrypt = select_one();
	goto Node_115_2878;
	Node_115_2878:;
	// End of Function
}
void generateKeyPair(signed int client, signed int seed) {
__iv__current_func_call = 208;	setClientPrivateKey(client, seed);
	goto Node_116_2881;
	Node_116_2881:;
	// End of Function
}
...
__iv__current_func_call = 209;	setup_bob__role__Keys(bob___0);
	goto Node_117_2889;
	Node_117_2886:;
__iv__current_func_call = 210;	setup_bob__before__Keys(bob___0);
	goto Node_117_2889;
	Node_117_2889:;
	// End of Function
}
...
__iv__current_func_call = 211;	setup_rjh__role__Keys(rjh___0);
	goto Node_118_2897;
	Node_118_2894:;
__iv__current_func_call = 212;	setup_rjh__before__Keys(rjh___0);
	goto Node_118_2897;
	Node_118_2897:;
	// End of Function
}
void bobKeyAddChuck() {
__iv__current_func_call = 213;	createClientKeyringEntry(bob);
__iv__current_func_call = 214;	setClientKeyringUser(bob, 1, 3);
__iv__current_func_call = 215;	setClientKeyringPublicKey(bob, 1, 789);
	goto Node_119_2902;
	Node_119_2902:;
	// End of Function
}
void rjhKeyAdd() {
__iv__current_func_call = 216;	createClientKeyringEntry(rjh);
__iv__current_func_call = 217;	setClientKeyringUser(rjh, 0, 1);
__iv__current_func_call = 218;	setClientKeyringPublicKey(rjh, 0, 123);
	goto Node_120_2907;
	Node_120_2907:;
	// End of Function
}
void rjhKeyAddChuck() {
__iv__current_func_call = 219;	createClientKeyringEntry(rjh);
__iv__current_func_call = 220;	setClientKeyringUser(rjh, 0, 3);
__iv__current_func_call = 221;	setClientKeyringPublicKey(rjh, 0, 789);
	goto Node_121_2912;
	Node_121_2912:;
	// End of Function
}
void chuckKeyAddRjh() {
__iv__current_func_call = 222;	createClientKeyringEntry(chuck);
__iv__current_func_call = 223;	setClientKeyringUser(chuck, 0, 2);
__iv__current_func_call = 224;	setClientKeyringPublicKey(chuck, 0, 456);
	goto Node_122_2917;
	Node_122_2917:;
	// End of Function
}
void rjhSetAutoRespond() {
__iv__current_func_call = 225;	setClientAutoResponse(rjh, 1);
	goto Node_123_2920;
	Node_123_2920:;
	// End of Function
}
void rjhEnableForwarding() {
__iv__current_func_call = 226;	setClientForwardReceiver(rjh, chuck);
	goto Node_124_2923;
	Node_124_2923:;
	// End of Function
}
void setup_bob__before__Keys(signed int bob___0) {
__iv__current_func_call = 227;	setClientId(bob___0, bob___0);
	goto Node_125_2926;
	Node_125_2926:;
	// End of Function
}
void setup_bob__role__Keys(signed int bob___0) {
__iv__current_func_call = 228;	setup_bob__before__Keys(bob___0);
__iv__current_func_call = 229;	setClientPrivateKey(bob___0, 123);
	goto Node_126_2930;
	Node_126_2930:;
	// End of Function
}
signed int isReadable__role__Encrypt(signed int msg) {
	signed int retValue_acc;
	signed int tmp;
__iv__current_func_call = 230;	tmp = isEncrypted(msg);
	if (!((tmp != 0))) goto Node_127_2941;
	retValue_acc = 0;
	return retValue_acc;
	Node_127_2941:;
__iv__current_func_call = 231;	retValue_acc = isReadable__before__Encrypt(msg);
	return retValue_acc;
}
void setup_rjh__role__Keys(signed int rjh___0) {
__iv__current_func_call = 232;	setup_rjh__before__Keys(rjh___0);
__iv__current_func_call = 233;	setClientPrivateKey(rjh___0, 456);
	goto Node_128_2955;
	Node_128_2955:;
	// End of Function
}
