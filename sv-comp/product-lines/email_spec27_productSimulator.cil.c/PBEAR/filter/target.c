...
char* __utac__get_this_argtype(signed int i, struct JoinPoint* this) {
	...
	signed int *mem_12;
	char ***mem_13;
	if (!((i > 0))) __CPROVER_printf("violated property: Node_45_883");
	assert((i > 0));
	...
	__cil_tmp6 = *mem_12;
	if (!((i <= __cil_tmp6))) __CPROVER_printf("violated property: Node_45_889");
	assert((i <= __cil_tmp6));
	Node_45_890:;
	__cil_tmp7 = (i - 1);
...
void* __utac__get_this_arg(signed int i, struct JoinPoint* this) {
	...
	signed int *mem_12;
	void ***mem_13;
	if (!((i > 0))) __CPROVER_printf("violated property: Node_46_936");
	assert((i > 0));
	...
	mem_12 = (signed int*)(__cil_tmp5);
	__cil_tmp6 = *mem_12;
	if (!((i <= __cil_tmp6))) __CPROVER_printf("violated property: Node_46_942");
	assert((i <= __cil_tmp6));
	Node_46_943:;
	__cil_tmp7 = (i - 1);
	__cil_tmp8 = (unsigned long int)(this);
...
void reach_error() {
	if (!(FALSE)) __CPROVER_printf("violated property: Node_50_1211");
	assert(FALSE);
	// End of Function
}
void rjhKeyAdd() {
...
void outgoing__before__AddressBook_131_2(signed int client, signed int msg);
void outgoing__before__Encrypt_95_2(signed int client, signed int msg);
void getClientId_101_2(signed int handle);
void setEmailFrom_102_2(signed int handle, signed int value);
void mail_103_2(signed int client, signed int msg);
void getEmailTo_162_2(signed int handle);
void incoming_163_2(signed int client, signed int msg);
void incoming__before__Decrypt_182_2(signed int client, signed int msg);
void incoming__role__Verify_69_2(signed int client, signed int msg);
void verify_71_2(signed int client, signed int msg);
void isSigned_51_2(signed int handle);
void getEmailFrom_52_2(signed int handle);
void getEmailSignKey_54_1(signed int handle);
void isKeyPairValid_55_1(signed int publicKey, signed int privateKey);
void setEmailIsSignatureVerified_56_1(signed int handle, signed int value);
void incoming__before__Verify_72_2(signed int client, signed int msg);
void incoming__role__Forward_208_2(signed int client, signed int msg);
void incoming__before__Forward_73_2(signed int client, signed int msg);
void incoming__role__AutoResponder_206_2(signed int client, signed int msg);
void incoming__before__AutoResponder_77_2(signed int client, signed int msg);
void deliver_190_2(signed int client, signed int msg);
void __utac_acc__VerifyForward_spec__1_171_2(signed int client, signed int msg);
void isVerified_211_2(signed int handle);
void getEmailFrom_212_1(signed int handle);
void findPublicKey_213_1(signed int handle, signed int userid);
void __automaton_fail_214_1();
void reach_error_173_1();
void select_helpers_0_1();
void select_features_1_1();
void select_one_226_1();
void select_one_227_1();
void select_one_228_1();
void select_one_229_1();
void select_one_230_1();
void select_one_231_1();
void select_one_232_1();
void select_one_233_1();
void valid_product_2_1();
void setup_3_1();
void setup_bob_164_1(signed int bob___0);
void setup_bob__role__Keys_216_1(signed int bob___0);
void setup_bob__before__Keys_108_1(signed int bob___0);
void setClientId_223_1(signed int handle, signed int value);
void setClientPrivateKey_109_1(signed int handle, signed int value);
void setup_rjh_166_1(signed int rjh___0);
void setup_rjh__role__Keys_199_1(signed int rjh___0);
void setup_rjh__before__Keys_47_1(signed int rjh___0);
void setClientId_49_1(signed int handle, signed int value);
void setClientPrivateKey_48_1(signed int handle, signed int value);
void setup_chuck_168_1(signed int chuck___0);
void setup_chuck__role__Keys_218_1(signed int chuck___0);
void setup_chuck__before__Keys_44_1(signed int chuck___0);
void setClientId_46_1(signed int handle, signed int value);
void setClientPrivateKey_45_1(signed int handle, signed int value);
void test_4_1();
void chuckKeyAdd_159_1();
void createClientKeyringEntry_196_1(signed int handle);
void getClientKeyringSize_104_1(signed int handle);
void setClientKeyringSize_105_1(signed int handle, signed int value);
void setClientKeyringUser_197_1(signed int handle, signed int index, signed int value);
void setClientKeyringPublicKey_198_1(signed int handle, signed int index, signed int value);
void rjhSetAutoRespond_141_1();
void setClientAutoResponse_129_1(signed int handle, signed int value);
void rjhDeletePrivateKey_143_1();
void setClientPrivateKey_170_1(signed int handle, signed int value);
void rjhEnableForwarding_149_1();
void setClientForwardReceiver_189_1(signed int handle, signed int value);
void bobToRjh_160_1();
void sendEmail_39_1(signed int sender, signed int receiver);
void createEmail_120_1(signed int from, signed int to);
void setEmailFrom_9_1(signed int handle, signed int value);
void setEmailTo_10_1(signed int handle, signed int value);
void outgoing_121_1(signed int client, signed int msg);
void outgoing__role__Sign_224_1(signed int client, signed int msg);
void sign_80_1(signed int client, signed int msg);
void getClientPrivateKey_5_1(signed int handle);
void setEmailIsSigned_6_1(signed int handle, signed int value);
void setEmailSignKey_7_1(signed int handle, signed int value);
void outgoing__before__Sign_81_1(signed int client, signed int msg);
void outgoing__before__AddressBook_131_1(signed int client, signed int msg);
void outgoing__before__Encrypt_95_1(signed int client, signed int msg);
void getClientId_101_1(signed int handle);
void setEmailFrom_102_1(signed int handle, signed int value);
void mail_103_1(signed int client, signed int msg);
void getEmailTo_162_1(signed int handle);
void incoming_163_1(signed int client, signed int msg);
void incoming__before__Decrypt_182_1(signed int client, signed int msg);
void incoming__role__Verify_69_1(signed int client, signed int msg);
void verify_71_1(signed int client, signed int msg);
void isSigned_51_1(signed int handle);
void getEmailFrom_52_1(signed int handle);
void incoming__before__Verify_72_1(signed int client, signed int msg);
void incoming__role__Forward_208_1(signed int client, signed int msg);
void incoming__before__Forward_73_1(signed int client, signed int msg);
void incoming__role__AutoResponder_206_1(signed int client, signed int msg);
void incoming__before__AutoResponder_77_1(signed int client, signed int msg);
void deliver_190_1(signed int client, signed int msg);
void __utac_acc__VerifyForward_spec__1_171_1(signed int client, signed int msg);
void isVerified_211_1(signed int handle);
void getClientAutoResponse_78_1(signed int handle);
void autoRespond_79_1(signed int client, signed int msg);
void getEmailFrom_58_1(signed int handle);
void setEmailTo_59_1(signed int handle, signed int value);
void queue_60_1(signed int client, signed int msg);
void getClientForwardReceiver_74_1(signed int handle);
void setEmailTo_75_1(signed int handle, signed int value);
void forward_76_1(signed int client, signed int msg);
void printMail_235_1(signed int msg);
void printMail__role__Verify_201_1(signed int msg);
void printMail__before__Verify_122_1(signed int msg);
void printMail__role__Sign_203_1(signed int msg);
void printMail__before__Sign_176_1(signed int msg);
void printMail__before__Encrypt_16_1(signed int msg);
void getEmailId_22_1(signed int handle);
void getEmailFrom_24_1(signed int handle);
void getEmailTo_26_1(signed int handle);
void isReadable_28_1(signed int msg);
void isReadable__before__Encrypt_12_1(signed int msg);
void isSigned_177_1(signed int handle);
void getEmailSignKey_179_1(signed int handle);
void isVerified_123_1(signed int handle);
void queue_236_1(signed int client, signed int msg);
void is_queue_empty_40_1();
void get_queued_email_41_1();
void get_queued_client_42_1();
void outgoing_43_1(signed int client, signed int msg);
void outgoing__role__Sign_224_2(signed int client, signed int msg);
void sign_80_2(signed int client, signed int msg);
void getClientPrivateKey_5_2(signed int handle);
void outgoing__before__Sign_81_2(signed int client, signed int msg);
...
void outgoing__before__AddressBook_131_2(signed int client, signed int msg){
	...
	outgoing__before__Encrypt_95_2(client, msg);
}
void outgoing__before__Encrypt_95_2(signed int client, signed int msg){
	signed int tmp;
	getClientId_101_2(client);
	tmp = 2; 
	setEmailFrom_102_2(msg, tmp);
	mail_103_2(client, msg);
}
void getClientId_101_2(signed int handle){
	signed int retValue_acc;
	retValue_acc = 2; 
	__iv__return_expr_getClientId = 2; 
}
void setEmailFrom_102_2(signed int handle, signed int value){
...
void mail_103_2(signed int client, signed int msg){
	signed int tmp;
	getEmailTo_162_2(msg);
	tmp = 3; 
	incoming_163_2(tmp, msg);
}
void getEmailTo_162_2(signed int handle){
	signed int retValue_acc;
	retValue_acc = 3; 
	__iv__return_expr_getEmailTo = 3; 
}
void incoming_163_2(signed int client, signed int msg){
	__CPROVER_assume((!((__SELECTED_FEATURE_Decrypt != 0))));
	incoming__before__Decrypt_182_2(client, msg);
}
void incoming__before__Decrypt_182_2(signed int client, signed int msg){
	incoming__role__Verify_69_2(client, msg);
}
void incoming__role__Verify_69_2(signed int client, signed int msg){
	verify_71_2(client, msg);
	incoming__before__Verify_72_2(client, msg);
}
void verify_71_2(signed int client, signed int msg){
	signed int tmp;
	signed int tmp___0;
	...
	isSigned_51_2(msg);
	tmp___0 = __iv__return_expr_isSigned;
	__CPROVER_assume(((tmp___0 != 0)));
	getEmailFrom_52_2(msg);
	tmp___1 = __iv__return_expr_getEmailFrom;
	pubkey = __iv__findPublicKey_stub(client, tmp___1);
	__CPROVER_assume(!(!((pubkey != 0))));
	getEmailSignKey_54_1(msg);
	tmp___3 = 123; 
	isKeyPairValid_55_1(tmp___3, pubkey);
	tmp___4 = __iv__return_expr_isKeyPairValid;
	__CPROVER_assume(!(!((tmp___4 != 0))));
	setEmailIsSignatureVerified_56_1(msg, 1);
}
void isSigned_51_2(signed int handle){
	signed int retValue_acc;
	__CPROVER_assume(!(!((handle == 1))));
...
void getEmailSignKey_54_1(signed int handle){
	signed int retValue_acc;
	retValue_acc = 123; 
	__iv__return_expr_getEmailSignKey = 123; 
}
void isKeyPairValid_55_1(signed int publicKey, signed int privateKey){
	signed int retValue_acc;
...
void setEmailIsSignatureVerified_56_1(signed int handle, signed int value){
	__ste_email_isSignatureVerified0 = 1; 
}
void incoming__before__Verify_72_2(signed int client, signed int msg){
	__CPROVER_assume(!(!((__SELECTED_FEATURE_Forward != 0))));
	incoming__role__Forward_208_2(client, msg);
}
void incoming__role__Forward_208_2(signed int client, signed int msg){
	signed int fwreceiver;
	incoming__before__Forward_73_2(client, msg);
}
void incoming__before__Forward_73_2(signed int client, signed int msg){
	__CPROVER_assume(!(!((__SELECTED_FEATURE_AutoResponder != 0))));
	incoming__role__AutoResponder_206_2(client, msg);
}
void incoming__role__AutoResponder_206_2(signed int client, signed int msg){
	signed int tmp;
	incoming__before__AutoResponder_77_2(client, msg);
}
void incoming__before__AutoResponder_77_2(signed int client, signed int msg){
	deliver_190_2(client, msg);
}
void deliver_190_2(signed int client, signed int msg){
	signed int __utac__ad__arg1;
	signed int __utac__ad__arg2;
	__utac__ad__arg1 = 3; 
	__utac__ad__arg2 = 1; 
	__utac_acc__VerifyForward_spec__1_171_2(__utac__ad__arg1, __utac__ad__arg2);
}
void __utac_acc__VerifyForward_spec__1_171_2(signed int client, signed int msg){
	signed int pubkey;
	signed int tmp;
	signed int tmp___1;
	isVerified_211_2(msg);
	tmp___1 = 1; 
	getEmailFrom_212_1(msg);
	tmp = __iv__return_expr_getEmailFrom;
	findPublicKey_213_1(client, tmp);
	pubkey = 0; 
	__automaton_fail_214_1();
}
void isVerified_211_2(signed int handle){
	signed int retValue_acc;
	retValue_acc = 1; 
	__iv__return_expr_isVerified = 1; 
}
void getEmailFrom_212_1(signed int handle){
	signed int retValue_acc;
	__CPROVER_assume(!(!((handle == 1))));
...
void reach_error_173_1(){
	__CPROVER_printf("violated property: Node_50_1211"); assert(0);
}
void select_helpers_0_1(){
	__GUIDSL_ROOT_PRODUCTION = 1; 
}
void select_features_1_1(){
	select_one_226_1();
	__SELECTED_FEATURE_Base = __iv__return_expr_select_one;
	select_one_227_1();
	__SELECTED_FEATURE_Keys = __iv__return_expr_select_one;
	select_one_228_1();
	__SELECTED_FEATURE_Encrypt = __iv__return_expr_select_one;
	select_one_229_1();
	__SELECTED_FEATURE_AutoResponder = __iv__return_expr_select_one;
	select_one_230_1();
	__SELECTED_FEATURE_AddressBook = __iv__return_expr_select_one;
	select_one_231_1();
	__SELECTED_FEATURE_Sign = __iv__return_expr_select_one;
	select_one_232_1();
	__SELECTED_FEATURE_Forward = __iv__return_expr_select_one;
	__SELECTED_FEATURE_Verify = 1; 
	select_one_233_1();
	__SELECTED_FEATURE_Decrypt = __iv__return_expr_select_one;
}
void select_one_226_1(){
	signed int retValue_acc;
	signed int choice;
	choice = __VERIFIER_nondet_signed_int(); __CPROVER_printf("__iv__test_case:%d", choice);
	retValue_acc = choice;
...
void valid_product_2_1(){
	...
	tmp = 1; 
	retValue_acc = 1; 
	__iv__return_expr_valid_product = 1; 
}
void setup_3_1(){
	...
	__cil_tmp2 = (char*)("rjh: %d\n");
	chuck = 3; 
	setup_chuck_168_1(chuck);
	__cil_tmp3 = (char*)("chuck: %d\n");
}
void setup_bob_164_1(signed int bob___0){
	__CPROVER_assume(!(!((__SELECTED_FEATURE_Keys != 0))));
	setup_bob__role__Keys_216_1(bob___0);
}
void setup_bob__role__Keys_216_1(signed int bob___0){
	setup_bob__before__Keys_108_1(bob___0);
	setClientPrivateKey_109_1(bob___0, 123);
}
void setup_bob__before__Keys_108_1(signed int bob___0){
	setClientId_223_1(bob___0, bob___0);
}
void setClientId_223_1(signed int handle, signed int value){
	__ste_client_idCounter0 = 1; 
}
void setClientPrivateKey_109_1(signed int handle, signed int value){
	__ste_client_privateKey0 = 123; 
}
void setup_rjh_166_1(signed int rjh___0){
	__CPROVER_assume(!(!((__SELECTED_FEATURE_Keys != 0))));
	setup_rjh__role__Keys_199_1(rjh___0);
}
void setup_rjh__role__Keys_199_1(signed int rjh___0){
	setup_rjh__before__Keys_47_1(rjh___0);
	setClientPrivateKey_48_1(rjh___0, 456);
}
void setup_rjh__before__Keys_47_1(signed int rjh___0){
	setClientId_49_1(rjh___0, rjh___0);
}
void setClientId_49_1(signed int handle, signed int value){
	__ste_client_idCounter1 = 2; 
}
void setClientPrivateKey_48_1(signed int handle, signed int value){
	__ste_client_privateKey1 = 456; 
}
void setup_chuck_168_1(signed int chuck___0){
	__CPROVER_assume(!(!((__SELECTED_FEATURE_Keys != 0))));
	setup_chuck__role__Keys_218_1(chuck___0);
}
void setup_chuck__role__Keys_218_1(signed int chuck___0){
	setup_chuck__before__Keys_44_1(chuck___0);
	setClientPrivateKey_45_1(chuck___0, 789);
}
void setup_chuck__before__Keys_44_1(signed int chuck___0){
	setClientId_46_1(chuck___0, chuck___0);
}
void setClientId_46_1(signed int handle, signed int value){
	__ste_client_idCounter2 = 3; 
}
void setClientPrivateKey_45_1(signed int handle, signed int value){
	__ste_client_privateKey2 = 789; 
}
void test_4_1(){
	signed int op1;
	signed int op2;
	...
	chuckKeyAdd_159_1();
	op11 = 1; 
	splverifierCounter = 2; 
	tmp___9 = 0; 
	tmp___8 = 16384; 
	__CPROVER_assume(!(!((__SELECTED_FEATURE_AutoResponder != 0))));
	rjhSetAutoRespond_141_1();
	op2 = 1; 
	splverifierCounter = 3; 
	tmp___9 = 0; 
	tmp___7 = 8; 
	__CPROVER_assume(!(!((__SELECTED_FEATURE_Keys != 0))));
	rjhDeletePrivateKey_143_1();
	op3 = 1; 
	...
	tmp___4 = 16777216; 
	__CPROVER_assume(!(!((__SELECTED_FEATURE_Forward != 0))));
	rjhEnableForwarding_149_1();
	op6 = 1; 
	bobToRjh_160_1();
}
void chuckKeyAdd_159_1(){
	createClientKeyringEntry_196_1(chuck);
	setClientKeyringUser_197_1(chuck, 0, 1);
	setClientKeyringPublicKey_198_1(chuck, 0, 123);
}
void createClientKeyringEntry_196_1(signed int handle){
	signed int retValue_acc;
	signed int size;
	signed int __cil_tmp5;
	getClientKeyringSize_104_1(handle);
	size = 0; 
	__cil_tmp5 = 1; 
	setClientKeyringSize_105_1(handle, __cil_tmp5);
	retValue_acc = 1; 
	__iv__return_expr_createClientKeyringEntry = 1; 
}
void getClientKeyringSize_104_1(signed int handle){
	signed int retValue_acc;
	retValue_acc = 0; 
	__iv__return_expr_getClientKeyringSize = 0; 
}
void setClientKeyringSize_105_1(signed int handle, signed int value){
	__ste_ClientKeyring_size2 = 1; 
}
void setClientKeyringUser_197_1(signed int handle, signed int index, signed int value){
	__CPROVER_assume((!((handle == 1))));
...
void rjhSetAutoRespond_141_1(){
	setClientAutoResponse_129_1(rjh, 1);
}
void setClientAutoResponse_129_1(signed int handle, signed int value){
	__ste_client_autoResponse1 = 1; 
}
void rjhDeletePrivateKey_143_1(){
	setClientPrivateKey_170_1(rjh, 0);
}
void setClientPrivateKey_170_1(signed int handle, signed int value){
	__ste_client_privateKey1 = 0; 
}
void rjhEnableForwarding_149_1(){
	setClientForwardReceiver_189_1(rjh, chuck);
}
void setClientForwardReceiver_189_1(signed int handle, signed int value){
	__ste_client_forwardReceiver1 = 3; 
}
void bobToRjh_160_1(){
	signed int tmp;
	signed int tmp___0;
	signed int tmp___1;
	sendEmail_39_1(bob, rjh);
	is_queue_empty_40_1();
	tmp___1 = 0; 
	get_queued_email_41_1();
	tmp = 1; 
	get_queued_client_42_1();
	tmp___0 = 2; 
	outgoing_43_1(tmp___0, tmp);
}
void sendEmail_39_1(signed int sender, signed int receiver){
	signed int email;
	createEmail_120_1(0, receiver);
	email = 1; 
	outgoing_121_1(sender, email);
}
void createEmail_120_1(signed int from, signed int to){
	signed int retValue_acc;
	signed int msg;
	msg = 1; 
	setEmailFrom_9_1(msg, from);
	setEmailTo_10_1(msg, to);
	retValue_acc = 1; 
	__iv__return_expr_createEmail = 1; 
}
void setEmailFrom_9_1(signed int handle, signed int value){
	__CPROVER_assume(!(!((handle == 1))));
	__ste_email_from0 = value;
...
void outgoing_121_1(signed int client, signed int msg){
	__CPROVER_assume(!(!((__SELECTED_FEATURE_Sign != 0))));
	outgoing__role__Sign_224_1(client, msg);
}
void outgoing__role__Sign_224_1(signed int client, signed int msg){
	sign_80_1(client, msg);
	outgoing__before__Sign_81_1(client, msg);
}
void sign_80_1(signed int client, signed int msg){
	signed int privkey;
	getClientPrivateKey_5_1(client);
	privkey = 123; 
	setEmailIsSigned_6_1(msg, 1);
	setEmailSignKey_7_1(msg, privkey);
}
void getClientPrivateKey_5_1(signed int handle){
	signed int retValue_acc;
	retValue_acc = 123; 
	__iv__return_expr_getClientPrivateKey = 123; 
}
void setEmailIsSigned_6_1(signed int handle, signed int value){
	__CPROVER_assume(!(!((handle == 1))));
	__ste_email_isSigned0 = value;
...
void setEmailSignKey_7_1(signed int handle, signed int value){
	__ste_email_signKey0 = 123; 
}
void outgoing__before__Sign_81_1(signed int client, signed int msg){
	__CPROVER_assume((!((__SELECTED_FEATURE_AddressBook != 0))));
	outgoing__before__AddressBook_131_1(client, msg);
}
void outgoing__before__AddressBook_131_1(signed int client, signed int msg){
	__CPROVER_assume((!((__SELECTED_FEATURE_Encrypt != 0))));
	outgoing__before__Encrypt_95_1(client, msg);
}
void outgoing__before__Encrypt_95_1(signed int client, signed int msg){
	signed int tmp;
	getClientId_101_1(client);
	tmp = 1; 
	setEmailFrom_102_1(msg, tmp);
	mail_103_1(client, msg);
}
void getClientId_101_1(signed int handle){
	signed int retValue_acc;
	retValue_acc = 1; 
	__iv__return_expr_getClientId = 1; 
}
void setEmailFrom_102_1(signed int handle, signed int value){
	__CPROVER_assume(!(!((handle == 1))));
	__ste_email_from0 = value;
...
void mail_103_1(signed int client, signed int msg){
	signed int tmp;
	getEmailTo_162_1(msg);
	tmp = 2; 
	incoming_163_1(tmp, msg);
}
void getEmailTo_162_1(signed int handle){
	signed int retValue_acc;
	retValue_acc = 2; 
	__iv__return_expr_getEmailTo = 2; 
}
void incoming_163_1(signed int client, signed int msg){
	__CPROVER_assume((!((__SELECTED_FEATURE_Decrypt != 0))));
	incoming__before__Decrypt_182_1(client, msg);
}
void incoming__before__Decrypt_182_1(signed int client, signed int msg){
	incoming__role__Verify_69_1(client, msg);
}
void incoming__role__Verify_69_1(signed int client, signed int msg){
	verify_71_1(client, msg);
	incoming__before__Verify_72_1(client, msg);
}
void verify_71_1(signed int client, signed int msg){
	signed int tmp;
	signed int tmp___0;
...
void incoming__before__Verify_72_1(signed int client, signed int msg){
	__CPROVER_assume(!(!((__SELECTED_FEATURE_Forward != 0))));
	incoming__role__Forward_208_1(client, msg);
}
void incoming__role__Forward_208_1(signed int client, signed int msg){
	signed int fwreceiver;
	incoming__before__Forward_73_1(client, msg);
	getClientForwardReceiver_74_1(client);
	fwreceiver = 3; 
	setEmailTo_75_1(msg, fwreceiver);
	forward_76_1(client, msg);
}
void incoming__before__Forward_73_1(signed int client, signed int msg){
	__CPROVER_assume(!(!((__SELECTED_FEATURE_AutoResponder != 0))));
	incoming__role__AutoResponder_206_1(client, msg);
}
void incoming__role__AutoResponder_206_1(signed int client, signed int msg){
	signed int tmp;
	incoming__before__AutoResponder_77_1(client, msg);
	getClientAutoResponse_78_1(client);
	tmp = 1; 
	autoRespond_79_1(client, msg);
}
void incoming__before__AutoResponder_77_1(signed int client, signed int msg){
	deliver_190_1(client, msg);
}
void deliver_190_1(signed int client, signed int msg){
	signed int __utac__ad__arg1;
	signed int __utac__ad__arg2;
	__utac__ad__arg1 = 2; 
	__utac__ad__arg2 = 1; 
	__utac_acc__VerifyForward_spec__1_171_1(__utac__ad__arg1, __utac__ad__arg2);
}
void __utac_acc__VerifyForward_spec__1_171_1(signed int client, signed int msg){
	signed int pubkey;
	signed int tmp;
	signed int tmp___1;
	isVerified_211_1(msg);
	tmp___1 = 0; 
}
void isVerified_211_1(signed int handle){
	signed int retValue_acc;
	retValue_acc = 0; 
	__iv__return_expr_isVerified = 0; 
}
void getClientAutoResponse_78_1(signed int handle){
	signed int retValue_acc;
	retValue_acc = 1; 
	__iv__return_expr_getClientAutoResponse = 1; 
}
void autoRespond_79_1(signed int client, signed int msg){
	signed int sender;
	getEmailFrom_58_1(msg);
	sender = __iv__return_expr_getEmailFrom;
	setEmailTo_59_1(msg, sender);
	queue_60_1(client, msg);
}
void getEmailFrom_58_1(signed int handle){
	signed int retValue_acc;
	__CPROVER_assume(!(!((handle == 1))));
...
void getClientForwardReceiver_74_1(signed int handle){
	signed int retValue_acc;
	retValue_acc = 3; 
	__iv__return_expr_getClientForwardReceiver = 3; 
}
void setEmailTo_75_1(signed int handle, signed int value){
	__ste_email_to0 = 3; 
}
void forward_76_1(signed int client, signed int msg){
	printMail_235_1(msg);
	queue_236_1(client, msg);
}
void printMail_235_1(signed int msg){
	printMail__role__Verify_201_1(msg);
}
void printMail__role__Verify_201_1(signed int msg){
	signed int tmp;
	const char * restrict __cil_tmp3;
	printMail__before__Verify_122_1(msg);
	isVerified_123_1(msg);
	tmp = 0; 
	__cil_tmp3 = (char*)("SIGNATURE VERIFIED\n  %d\n");
}
void printMail__before__Verify_122_1(signed int msg){
	__CPROVER_assume(!(!((__SELECTED_FEATURE_Sign != 0))));
	printMail__role__Sign_203_1(msg);
}
void printMail__role__Sign_203_1(signed int msg){
	signed int tmp;
	signed int tmp___0;
	...
	printMail__before__Sign_176_1(msg);
	isSigned_177_1(msg);
	tmp = __iv__return_expr_isSigned;
	__cil_tmp4 = (char*)("SIGNED\n  %i\n");
	getEmailSignKey_179_1(msg);
	tmp___0 = 123; 
	__cil_tmp5 = (char*)("SIGNATURE\n  %i\n");
}
void printMail__before__Sign_176_1(signed int msg){
	__CPROVER_assume((!((__SELECTED_FEATURE_Encrypt != 0))));
	printMail__before__Encrypt_16_1(msg);
}
void printMail__before__Encrypt_16_1(signed int msg){
	signed int tmp;
	signed int tmp___0;
	...
	tmp = 0; 
	__cil_tmp6 = (char*)("ID:\n  %i\n");
	getEmailFrom_24_1(msg);
	tmp___0 = __iv__return_expr_getEmailFrom;
	__cil_tmp7 = (char*)("FROM:\n  %i\n");
	getEmailTo_26_1(msg);
	tmp___1 = 3; 
	__cil_tmp8 = (char*)("TO:\n  %i\n");
	isReadable_28_1(msg);
	tmp___2 = __iv__return_expr_isReadable;
	__cil_tmp9 = (char*)("IS_READABLE\n  %i\n");
}
void getEmailId_22_1(signed int handle){
	signed int retValue_acc;
	retValue_acc = 0; 
	__iv__return_expr_getEmailId = 0; 
}
void getEmailFrom_24_1(signed int handle){
	signed int retValue_acc;
	__CPROVER_assume(!(!((handle == 1))));
...
void isReadable_28_1(signed int msg){
	signed int retValue_acc;
	__CPROVER_assume((!((__SELECTED_FEATURE_Encrypt != 0))));
	isReadable__before__Encrypt_12_1(msg);
	retValue_acc = __iv__return_expr_isReadable__before__Encrypt;
...
void is_queue_empty_40_1(){
	signed int retValue_acc;
	retValue_acc = 0; 
	__iv__return_expr_is_queue_empty = 0; 
}
void get_queued_email_41_1(){
	signed int retValue_acc;
	retValue_acc = 1; 
	__iv__return_expr_get_queued_email = 1; 
}
void get_queued_client_42_1(){
	signed int retValue_acc;
	retValue_acc = 2; 
	__iv__return_expr_get_queued_client = 2; 
}
void outgoing_43_1(signed int client, signed int msg){
	__CPROVER_assume(!(!((__SELECTED_FEATURE_Sign != 0))));
	outgoing__role__Sign_224_2(client, msg);
}
void outgoing__role__Sign_224_2(signed int client, signed int msg){
	sign_80_2(client, msg);
	outgoing__before__Sign_81_2(client, msg);
}
void sign_80_2(signed int client, signed int msg){
	signed int privkey;
	getClientPrivateKey_5_2(client);
	privkey = 0; 
}
void getClientPrivateKey_5_2(signed int handle){
	signed int retValue_acc;
	retValue_acc = 0; 
	__iv__return_expr_getClientPrivateKey = 0; 
}
void outgoing__before__Sign_81_2(signed int client, signed int msg){
	__CPROVER_assume((!((__SELECTED_FEATURE_AddressBook != 0))));
	outgoing__before__AddressBook_131_2(client, msg);
}
signed int __iv__isReadable_stub(signed int msg){
	__CPROVER_printf("__iv__stub_call:isReadable");
	...
	__CPROVER_printf("__iv__stub_input:__ste_email_isEncrypted0=%d", __ste_email_isEncrypted0);
	__CPROVER_printf("__iv__stub_input:__ste_email_isEncrypted1=%d", __ste_email_isEncrypted1);
	signed int __iv__return_expr_isReadable;
	...
	__CPROVER_printf("__iv__stub_output:__iv__return_expr_isReadable=%d", __iv__return_expr_isReadable);
	return __iv__return_expr_isReadable;
}
signed int __iv__findPublicKey_stub(signed int handle, signed int userid){
	__CPROVER_printf("__iv__stub_call:findPublicKey");
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring1_User1=%d", __ste_Client_Keyring1_User1);
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring2_PublicKey0=%d", __ste_Client_Keyring2_PublicKey0);
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring2_PublicKey1=%d", __ste_Client_Keyring2_PublicKey1);
	__CPROVER_printf("__iv__stub_input:handle=%d", handle);
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring2_User0=%d", __ste_Client_Keyring2_User0);
	__CPROVER_printf("__iv__stub_input:userid=%d", userid);
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring2_User1=%d", __ste_Client_Keyring2_User1);
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring0_PublicKey0=%d", __ste_Client_Keyring0_PublicKey0);
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring0_PublicKey1=%d", __ste_Client_Keyring0_PublicKey1);
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring0_User0=%d", __ste_Client_Keyring0_User0);
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring0_User1=%d", __ste_Client_Keyring0_User1);
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring1_PublicKey0=%d", __ste_Client_Keyring1_PublicKey0);
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring1_PublicKey1=%d", __ste_Client_Keyring1_PublicKey1);
	__CPROVER_printf("__iv__stub_input:__ste_Client_Keyring1_User0=%d", __ste_Client_Keyring1_User0);
	signed int __iv__return_expr_findPublicKey;
	if(1==handle) if(userid==__ste_Client_Keyring0_User0) __iv__return_expr_findPublicKey = __ste_Client_Keyring0_PublicKey0; else __iv__return_expr_findPublicKey = __ste_Client_Keyring0_PublicKey1; else if(2==handle) if(userid==__ste_Client_Keyring1_User0) __iv__return_expr_findPublicKey = __ste_Client_Keyring1_PublicKey0; else __iv__return_expr_findPublicKey = __ste_Client_Keyring1_PublicKey1; else if(userid==__ste_Client_Keyring2_User1) __iv__return_expr_findPublicKey = __ste_Client_Keyring2_PublicKey1; else if(3==__ste_Client_Keyring1_User1) __iv__return_expr_findPublicKey = __ste_Client_Keyring2_PublicKey0; else if(userid<__ste_Client_Keyring0_User1) __iv__return_expr_findPublicKey = __ste_Client_Keyring2_PublicKey0; else __iv__return_expr_findPublicKey = 0; 
	__CPROVER_printf("__iv__stub_output:__iv__return_expr_findPublicKey=%d", __iv__return_expr_findPublicKey);
