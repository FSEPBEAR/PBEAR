...
int main(){
	...
	return_value___VERIFIER_nondet_int = 1048576; 
	main1_1_1();
}
void main1_1_1(){
	signed char x;
	...
	__VERIFIER_assert_13_1((signed int)(((signed int)(x) >= (signed int)(g))));
}
void __VERIFIER_assert_13_1(int cond){
...
signed char __iv__gcd_test_stub(signed char a, signed char b){
	...
	signed char __iv__return_expr_gcd_test;
	if(2==(b%a)) __iv__return_expr_gcd_test = 2; else if((-1)==b) __iv__return_expr_gcd_test = 1; else if((-1)>=(a%2)) __iv__return_expr_gcd_test = 1; else if((-1)>=(a%3)) __iv__return_expr_gcd_test = 1; else if((-1)>=a) __iv__return_expr_gcd_test = 2; else if((b%a)>=3) __iv__return_expr_gcd_test = 1; else __iv__return_expr_gcd_test = (a%(-4)); 
