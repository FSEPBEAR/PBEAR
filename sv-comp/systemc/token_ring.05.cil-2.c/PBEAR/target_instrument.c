...
void start_simulation() {
	...
	signed int tmp___0;
	kernel_st = 0;
__iv__current_func_call = 2;	update_channels();
__iv__current_func_call = 3;	init_threads();
__iv__current_func_call = 4;	fire_delta_events();
__iv__current_func_call = 5;	activate_threads();
__iv__current_func_call = 6;	reset_delta_events();
	Node_2_22:;
	if (!((1 != 0))) goto Node_2_44;
	kernel_st = 1;
__iv__current_func_call = 7;	eval();
	kernel_st = 2;
__iv__current_func_call = 8;	update_channels();
	kernel_st = 3;
...
__iv__current_func_call = 12;	tmp = exists_runnable_thread();
	if (!((tmp == 0))) goto Node_2_38;
	kernel_st = 4;
__iv__current_func_call = 13;	fire_time_events();
__iv__current_func_call = 14;	activate_threads();
__iv__current_func_call = 15;	reset_time_events();
	Node_2_38:;
__iv__current_func_call = 16;	tmp___0 = stop_simulation();
...
void error() {
__iv__current_func_call = 17;	reach_error();
	abort();
}
...
__iv__current_func_call = 20;	tmp = exists_runnable_thread();
...
__iv__current_func_call = 21;	tmp = exists_runnable_thread();
	...
	m_st = 1;
__iv__current_func_call = 23;	master();
	Node_7_95:;
	Node_7_97:;
	...
	t1_st = 1;
__iv__current_func_call = 25;	transmit1();
	Node_7_104:;
	Node_7_106:;
	...
	t2_st = 1;
__iv__current_func_call = 27;	transmit2();
	Node_7_113:;
	Node_7_115:;
	...
	t3_st = 1;
__iv__current_func_call = 29;	transmit3();
	Node_7_122:;
	Node_7_124:;
	...
	t4_st = 1;
__iv__current_func_call = 31;	transmit4();
	Node_7_131:;
	Node_7_133:;
	...
	t5_st = 1;
__iv__current_func_call = 33;	transmit5();
	Node_7_140:;
	Node_7_142:;
	goto Node_7_83;
	Node_7_144:;
...
void transmit1() {
	...
	token = (token + 1);
	E_2 = 1;
__iv__current_func_call = 34;	immediate_notify();
	E_2 = 2;
	goto Node_9_169;
	Node_9_179:;
	Node_9_181:;
...
void transmit2() {
	...
	token = (token + 1);
	E_3 = 1;
__iv__current_func_call = 35;	immediate_notify();
	E_3 = 2;
	goto Node_10_191;
	Node_10_201:;
	Node_10_203:;
...
__iv__current_func_call = 36;	activate_threads();
	goto Node_16_324;
	Node_16_324:;
	// End of Function
}
...
void activate_threads() {
	...
	signed int tmp___3;
	signed int tmp___4;
__iv__current_func_call = 37;	tmp = is_master_triggered();
	if (!((tmp != 0))) goto Node_18_372;
	m_st = 0;
	Node_18_372:;
__iv__current_func_call = 38;	tmp___0 = is_transmit1_triggered();
	if (!((tmp___0 != 0))) goto Node_18_376;
	t1_st = 0;
	Node_18_376:;
__iv__current_func_call = 39;	tmp___1 = is_transmit2_triggered();
	if (!((tmp___1 != 0))) goto Node_18_380;
	t2_st = 0;
	Node_18_380:;
__iv__current_func_call = 40;	tmp___2 = is_transmit3_triggered();
	if (!((tmp___2 != 0))) goto Node_18_384;
	t3_st = 0;
	Node_18_384:;
__iv__current_func_call = 41;	tmp___3 = is_transmit4_triggered();
	if (!((tmp___3 != 0))) goto Node_18_388;
	t4_st = 0;
	Node_18_388:;
__iv__current_func_call = 42;	tmp___4 = is_transmit5_triggered();
...
void transmit4() {
	...
	token = (token + 1);
	E_5 = 1;
__iv__current_func_call = 43;	immediate_notify();
	E_5 = 2;
	goto Node_20_441;
	Node_20_451:;
	Node_20_453:;
...
void transmit5() {
	...
	token = (token + 1);
	E_M = 1;
__iv__current_func_call = 44;	immediate_notify();
	E_M = 2;
	goto Node_22_501;
	Node_22_511:;
	Node_22_513:;
...
void master() {
	...
	local = token;
	E_1 = 1;
__iv__current_func_call = 47;	immediate_notify();
	E_1 = 2;
	m_pc = 1;
	m_st = 2;
	goto Node_26_582;
...
__iv__current_func_call = 48;	error();
	goto Node_26_578;
	Node_26_567:;
...
__iv__current_func_call = 49;	error();
	Node_26_575:;
	Node_26_576:;
	Node_26_577:;
	Node_26_578:;
...
void transmit3() {
	...
	token = (token + 1);
	E_4 = 1;
__iv__current_func_call = 50;	immediate_notify();
	E_4 = 2;
	goto Node_27_594;
	Node_27_604:;
	Node_27_606:;
